...
echo "Verifying Shader System integration..."
...
# Test main
TEST_MAIN="Source/Runtime/Rendering/Private/Shaders/shader_test_main.c"
...
if [ $? -ne 0 ]; then
    echo "Shader System compilation FAILED."
    exit 1
fi

echo "Shader System compiled successfully."
echo "Running Shader Verification..."
./shader_test

if [ $? -eq 0 ]; then
    echo ""
    echo "Shader Verification Successful!"
    rm -f shader_test
else
    echo ""
    echo "Shader Verification FAILED."
    exit 1
fi
