...
#ifndef SHADOWS_ADVANCED_RT_SHADOW_CACHE_H
#define SHADOWS_ADVANCED_RT_SHADOW_CACHE_H
...
typedef struct shadows_advanced_rt_shadow_cache_handle {
    uint32_t id;
} shadows_advanced_rt_shadow_cache_handle_t;

typedef struct shadows_advanced_rt_shadow_cache_desc {
    uint32_t flags;
    void* user_data;
} shadows_advanced_rt_shadow_cache_desc_t;

typedef struct shadows_advanced_rt_shadow_cache_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shadows_advanced_rt_shadow_cache_info_t;
...
#endif /* SHADOWS_ADVANCED_RT_SHADOW_CACHE_H */
