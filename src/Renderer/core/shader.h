...
uint32_t shader_load_from_source(const char *name, const char *source_code,
                                 ShaderType type);
...
void shader_bind_compute(uint32_t module_id);
void shader_dispatch_compute(uint32_t module_id, uint32_t groups_x,
                             uint32_t groups_y, uint32_t groups_z);
void shader_set_uniform_compute(uint32_t module_id, const char *name,
                                void *data, uint32_t size);
void shader_memory_barrier_compute(void);

// Load compute shader helper
uint32_t shader_load_compute(const char *filepath);
