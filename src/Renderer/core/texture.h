...
#include "rendering/texture_system.h" // For Texture struct and TextureFormat
...
// Texture handle - compatibility with RenderGraph which expects TextureID type
// Defined in core/math/types.h as u32
...
void texture_bind_compute(TextureID texture, u32 slot);
void texture_bind_image_compute(TextureID texture, u32 slot);
