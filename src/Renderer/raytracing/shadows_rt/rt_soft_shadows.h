...
#ifndef RAYTRACING_RT_SOFT_SHADOWS_H
#define RAYTRACING_RT_SOFT_SHADOWS_H
...
typedef struct raytracing_rt_soft_shadows_handle {
    uint32_t id;
} raytracing_rt_soft_shadows_handle_t;

typedef struct raytracing_rt_soft_shadows_desc {
    uint32_t flags;
    void* user_data;
} raytracing_rt_soft_shadows_desc_t;

typedef struct raytracing_rt_soft_shadows_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} raytracing_rt_soft_shadows_info_t;
...
#endif /* RAYTRACING_RT_SOFT_SHADOWS_H */
