...
#ifndef POSTPROCESSING_SMAA_PASS_H
#define POSTPROCESSING_SMAA_PASS_H
...
typedef struct postprocessing_smaa_pass_handle {
    uint32_t id;
} postprocessing_smaa_pass_handle_t;

typedef struct postprocessing_smaa_pass_desc {
    uint32_t flags;
    void* user_data;
} postprocessing_smaa_pass_desc_t;

typedef struct postprocessing_smaa_pass_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} postprocessing_smaa_pass_info_t;
...
#endif /* POSTPROCESSING_SMAA_PASS_H */
