...
#ifndef SHADING_HAIR_AO_H
#define SHADING_HAIR_AO_H
...
typedef struct shading_hair_ao_handle {
    uint32_t id;
} shading_hair_ao_handle_t;

typedef struct shading_hair_ao_desc {
    uint32_t flags;
    void* user_data;
} shading_hair_ao_desc_t;

typedef struct shading_hair_ao_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shading_hair_ao_info_t;
