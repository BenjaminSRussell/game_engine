...
#ifndef SHADING_COAT_THICKNESS_H
#define SHADING_COAT_THICKNESS_H
...
typedef struct shading_coat_thickness_handle {
    uint32_t id;
} shading_coat_thickness_handle_t;

typedef struct shading_coat_thickness_desc {
    uint32_t flags;
    void* user_data;
} shading_coat_thickness_desc_t;

typedef struct shading_coat_thickness_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shading_coat_thickness_info_t;
...
#endif /* SHADING_COAT_THICKNESS_H */
