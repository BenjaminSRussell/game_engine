...
#ifndef NANITE_CLUSTER_CULL_GPU_H
#define NANITE_CLUSTER_CULL_GPU_H
...
typedef struct nanite_cluster_cull_gpu_handle {
    uint32_t id;
} nanite_cluster_cull_gpu_handle_t;

typedef struct nanite_cluster_cull_gpu_desc {
    uint32_t flags;
    void* user_data;
} nanite_cluster_cull_gpu_desc_t;

typedef struct nanite_cluster_cull_gpu_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} nanite_cluster_cull_gpu_info_t;
...
#endif /* NANITE_CLUSTER_CULL_GPU_H */
