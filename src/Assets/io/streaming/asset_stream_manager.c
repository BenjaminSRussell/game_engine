...
#include "assets/io/streaming/asset_stream_manager.h"
 ...
 * Complexity: O(n) where n is the number of elements
 */
int io_streaming_manager_01_create_legacy(io_streaming_manager_01_t* ctx, void* params) {
    if (!ctx) {
 ...
 * Complexity: O(n) where n is the number of elements
 */
int io_streaming_manager_01_destroy_legacy(io_streaming_manager_01_t* ctx, void* params) {
    if (!ctx) {
