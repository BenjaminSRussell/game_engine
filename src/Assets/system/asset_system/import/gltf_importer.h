...
#ifndef ASSET_SYSTEM_GLTF_IMPORTER_H
#define ASSET_SYSTEM_GLTF_IMPORTER_H
...
typedef struct asset_system_gltf_importer_handle {
    uint32_t id;
} asset_system_gltf_importer_handle_t;

typedef struct asset_system_gltf_importer_desc {
    uint32_t flags;
    void* user_data;
} asset_system_gltf_importer_desc_t;

typedef struct asset_system_gltf_importer_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} asset_system_gltf_importer_info_t;
...
#endif /* ASSET_SYSTEM_GLTF_IMPORTER_H */
