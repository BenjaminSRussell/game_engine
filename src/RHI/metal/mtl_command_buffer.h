...
#include "RHI/metal/mtl_device.h"
#include <stdbool.h>
...
void metal_command_buffer_set_label(mtl_command_buffer_t buffer,
                                    const char *label);
...
/* Debugging */
void metal_command_buffer_push_debug_group(mtl_command_buffer_t buffer,
                                           const char *label);
void metal_command_buffer_pop_debug_group(mtl_command_buffer_t buffer);

/* Status & Errors */
mtl_command_buffer_status_t
metal_command_buffer_get_status(mtl_command_buffer_t buffer);
mtl_command_buffer_error_t
metal_command_buffer_get_error(mtl_command_buffer_t buffer);
const char *metal_command_buffer_get_error_string(mtl_command_buffer_t buffer);

/* Calbacks */
void metal_command_buffer_add_scheduled_handler(
    mtl_command_buffer_t buffer, mtl_command_buffer_handler_t handler);
void metal_command_buffer_add_completed_handler(
    mtl_command_buffer_t buffer, mtl_command_buffer_handler_t handler);
