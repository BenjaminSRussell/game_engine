...
#ifndef RENDERING_FORWARD_CLUSTERING_H
#define RENDERING_FORWARD_CLUSTERING_H
...
typedef struct rendering_forward_clustering_handle {
    uint32_t id;
} rendering_forward_clustering_handle_t;

typedef struct rendering_forward_clustering_desc {
    uint32_t flags;
    void* user_data;
} rendering_forward_clustering_desc_t;

typedef struct rendering_forward_clustering_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} rendering_forward_clustering_info_t;
...
#endif /* RENDERING_FORWARD_CLUSTERING_H */
