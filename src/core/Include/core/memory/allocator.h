 ...
 * =================================================================================================
 *
 * Purpose: Defines a unified interface for memory allocation across different
 * allocator types (linear, pool, stack, aligned, etc.). Provides a polymorphic
 * allocator that can use any of the specialized allocators.
 */
...
/**
 * Generic allocator structure that can wrap any concrete allocator
 * implementation
 */
typedef struct {
  AllocatorType type;
  void *context; // Points to specific allocator implementation
                 // (LinearAllocator*, PoolAllocator*, etc.)
