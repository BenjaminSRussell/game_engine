#ifndef DELTA_COMPRESSION_H
#define DELTA_COMPRESSION_H
...
// Internal Functions
static StateSnapshot *delta_find_snapshot(DeltaCompressor *compressor,
                                          u32 sequence);
static bool delta_generate_diff(const void *base_state,
                                const void *target_state, u32 size,
