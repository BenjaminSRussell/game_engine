/*
 * io_caching_renderer_03.h
 *
 * Header file for io_caching_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef IO_CACHING_RENDERER_03_H
#define IO_CACHING_RENDERER_03_H
...
typedef struct io_caching_renderer_03 io_caching_renderer_03_t;
typedef struct io_caching_renderer_03_desc io_caching_renderer_03_desc_t;
typedef struct io_caching_renderer_03_stats io_caching_renderer_03_stats_t;

/* Creation and destruction */
int io_caching_renderer_03_create(io_caching_renderer_03_t** out_ctx, const io_caching_renderer_03_desc_t* desc);
int io_caching_renderer_03_destroy(io_caching_renderer_03_t* ctx);
...
#endif /* IO_CACHING_RENDERER_03_H */
