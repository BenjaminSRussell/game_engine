...
#ifndef ASSET_SYSTEM_ASSET_DEPENDENCIES_H
#define ASSET_SYSTEM_ASSET_DEPENDENCIES_H
...
typedef struct asset_system_asset_dependencies_handle {
    uint32_t id;
} asset_system_asset_dependencies_handle_t;

typedef struct asset_system_asset_dependencies_desc {
    uint32_t flags;
    void* user_data;
} asset_system_asset_dependencies_desc_t;

typedef struct asset_system_asset_dependencies_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} asset_system_asset_dependencies_info_t;
...
#endif /* ASSET_SYSTEM_ASSET_DEPENDENCIES_H */
