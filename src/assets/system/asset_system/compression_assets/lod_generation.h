...
#ifndef ASSET_SYSTEM_LOD_GENERATION_H
#define ASSET_SYSTEM_LOD_GENERATION_H
...
typedef struct asset_system_lod_generation_handle {
    uint32_t id;
} asset_system_lod_generation_handle_t;

typedef struct asset_system_lod_generation_desc {
    uint32_t flags;
    void* user_data;
} asset_system_lod_generation_desc_t;

typedef struct asset_system_lod_generation_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} asset_system_lod_generation_info_t;
...
#endif /* ASSET_SYSTEM_LOD_GENERATION_H */
