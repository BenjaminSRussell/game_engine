/*
 * physics_rigid_processor_04.h
 *
 * Header file for physics_rigid_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef PHYSICS_RIGID_PROCESSOR_04_H
#define PHYSICS_RIGID_PROCESSOR_04_H
...
typedef struct physics_rigid_processor_04 physics_rigid_processor_04_t;
typedef struct physics_rigid_processor_04_desc physics_rigid_processor_04_desc_t;
typedef struct physics_rigid_processor_04_stats physics_rigid_processor_04_stats_t;

/* Creation and destruction */
int physics_rigid_processor_04_create(physics_rigid_processor_04_t** out_ctx, const physics_rigid_processor_04_desc_t* desc);
int physics_rigid_processor_04_destroy(physics_rigid_processor_04_t* ctx);
...
#endif /* PHYSICS_RIGID_PROCESSOR_04_H */
