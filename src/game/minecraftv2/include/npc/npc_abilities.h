// Special NPC abilities API.
#ifndef NPC_ABILITIES_H
#define NPC_ABILITIES_H
...
struct NPCSystem;
// struct NPCComponent; // No longer needed due to include
// struct TransformComponent; // No longer needed due to include
