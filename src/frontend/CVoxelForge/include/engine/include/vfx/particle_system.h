...
//
// Purpose: General-purpose particle system for visual effects throughout the game.
// Extends the weather particle system for gameplay effects (explosions, impacts,
// magic, etc.).
//
// Key Features:
