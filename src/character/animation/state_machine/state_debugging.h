...
#ifndef ANIMATION_STATE_DEBUGGING_H
#define ANIMATION_STATE_DEBUGGING_H
...
typedef struct animation_state_debugging_handle {
    uint32_t id;
} animation_state_debugging_handle_t;

typedef struct animation_state_debugging_desc {
    uint32_t flags;
    void* user_data;
} animation_state_debugging_desc_t;

typedef struct animation_state_debugging_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} animation_state_debugging_info_t;
...
#endif /* ANIMATION_STATE_DEBUGGING_H */
