...
/* ============================================================================
 * LEGACY / SIMPLIFIED FORMAT SUPPORT (Task Request)
 * ============================================================================ */

typedef enum vertex_attribute_legacy {
...
} vertex_attribute_legacy_t;

typedef struct vertex_format {
    uint32_t attribute_mask;
    uint32_t stride;
    uint64_t formats[8]; // Stores MTLVertexFormat (NSUInteger)
    uint32_t offsets[8];
} vertex_format_t;
