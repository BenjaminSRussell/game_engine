...
#ifndef GEOMETRY_BVH_TRAVERSAL_H
#define GEOMETRY_BVH_TRAVERSAL_H
...
typedef struct geometry_bvh_traversal_handle {
    uint32_t id;
} geometry_bvh_traversal_handle_t;

typedef struct geometry_bvh_traversal_desc {
    uint32_t flags;
    void* user_data;
} geometry_bvh_traversal_desc_t;

typedef struct geometry_bvh_traversal_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} geometry_bvh_traversal_info_t;
...
#endif /* GEOMETRY_BVH_TRAVERSAL_H */
