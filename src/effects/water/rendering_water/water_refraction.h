...
#ifndef WATER_WATER_REFRACTION_H
#define WATER_WATER_REFRACTION_H
...
typedef struct water_water_refraction_handle {
    uint32_t id;
} water_water_refraction_handle_t;

typedef struct water_water_refraction_desc {
    uint32_t flags;
    void* user_data;
} water_water_refraction_desc_t;

typedef struct water_water_refraction_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} water_water_refraction_info_t;
...
#endif /* WATER_WATER_REFRACTION_H */
