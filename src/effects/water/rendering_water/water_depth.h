...
#ifndef WATER_WATER_DEPTH_H
#define WATER_WATER_DEPTH_H
...
typedef struct water_water_depth_handle {
    uint32_t id;
} water_water_depth_handle_t;

typedef struct water_water_depth_desc {
    uint32_t flags;
    void* user_data;
} water_water_depth_desc_t;

typedef struct water_water_depth_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} water_water_depth_info_t;
