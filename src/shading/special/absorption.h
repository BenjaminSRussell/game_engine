...
#ifndef SHADING_ABSORPTION_H
#define SHADING_ABSORPTION_H
...
typedef struct shading_absorption_handle {
    uint32_t id;
} shading_absorption_handle_t;

typedef struct shading_absorption_desc {
    uint32_t flags;
    void* user_data;
} shading_absorption_desc_t;

typedef struct shading_absorption_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shading_absorption_info_t;
