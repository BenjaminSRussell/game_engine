 ...
 * =================================================================================================
 *
 * Purpose: Defines fundamental types and structures used throughout the rendering pipeline.
 * Includes vertex formats, texture descriptors, material definitions, and render pass configurations.
 */
