...
#ifndef ATMOSPHERE_CLOUD_DENSITY_H
#define ATMOSPHERE_CLOUD_DENSITY_H
...
typedef struct atmosphere_cloud_density_handle {
    uint32_t id;
} atmosphere_cloud_density_handle_t;

typedef struct atmosphere_cloud_density_desc {
    uint32_t flags;
    void* user_data;
} atmosphere_cloud_density_desc_t;

typedef struct atmosphere_cloud_density_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} atmosphere_cloud_density_info_t;
...
#endif /* ATMOSPHERE_CLOUD_DENSITY_H */
