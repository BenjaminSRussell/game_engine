...
#include "environment/atmosphere/sky/atmosphere_common.h"
#include <simd/simd.h>
...
void atmosphere_render_sky(atmosphere_system_t *atmo,
                           id<MTLRenderCommandEncoder> encoder,
                           camera_t *camera);
void atmosphere_render_aerial_perspective(atmosphere_system_t *atmo,
                                          id<MTLRenderCommandEncoder> encoder,
                                          camera_t *camera,
                                          id<MTLTexture> depth_tex);
#else
void atmosphere_precompute(atmosphere_system_t *atmo, void *cmd);
void atmosphere_render_sky(atmosphere_system_t *atmo, void *encoder,
                           camera_t *camera);
void atmosphere_render_aerial_perspective(atmosphere_system_t *atmo,
                                          void *encoder, camera_t *camera,
                                          void *depth_tex);
#endif

void atmosphere_init(atmosphere_system_t *atmo, metal_device_t *dev);
void atmosphere_shutdown(atmosphere_system_t *atmo);
void atmosphere_update_params(atmosphere_system_t *atmo,
