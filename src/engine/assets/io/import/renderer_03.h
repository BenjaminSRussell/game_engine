/*
 * io_import_renderer_03.h
 *
 * Header file for io_import_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef IO_IMPORT_RENDERER_03_H
#define IO_IMPORT_RENDERER_03_H
...
typedef struct io_import_renderer_03 io_import_renderer_03_t;
typedef struct io_import_renderer_03_desc io_import_renderer_03_desc_t;
typedef struct io_import_renderer_03_stats io_import_renderer_03_stats_t;

/* Creation and destruction */
int io_import_renderer_03_create(io_import_renderer_03_t** out_ctx, const io_import_renderer_03_desc_t* desc);
int io_import_renderer_03_destroy(io_import_renderer_03_t* ctx);
