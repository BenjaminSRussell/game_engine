...
int io_caching_manager_01_create_legacy(io_caching_manager_01_t* ctx, void* params);
int io_caching_manager_01_destroy_legacy(io_caching_manager_01_t* ctx, void* params);
