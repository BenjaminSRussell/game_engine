/*
 * io_formats_renderer_03.h
 *
 * Header file for io_formats_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef IO_FORMATS_RENDERER_03_H
#define IO_FORMATS_RENDERER_03_H
...
typedef struct io_formats_renderer_03 io_formats_renderer_03_t;
typedef struct io_formats_renderer_03_desc io_formats_renderer_03_desc_t;
typedef struct io_formats_renderer_03_stats io_formats_renderer_03_stats_t;

/* Creation and destruction */
int io_formats_renderer_03_create(io_formats_renderer_03_t** out_ctx, const io_formats_renderer_03_desc_t* desc);
int io_formats_renderer_03_destroy(io_formats_renderer_03_t* ctx);
...
#endif /* IO_FORMATS_RENDERER_03_H */
