/*
 * physics_cloth_manager_01.h
 *
 * Header file for physics_cloth_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef PHYSICS_CLOTH_MANAGER_01_H
#define PHYSICS_CLOTH_MANAGER_01_H
...
typedef struct physics_cloth_manager_01 physics_cloth_manager_01_t;
typedef struct physics_cloth_manager_01_desc physics_cloth_manager_01_desc_t;
typedef struct physics_cloth_manager_01_stats physics_cloth_manager_01_stats_t;

/* Creation and destruction */
int physics_cloth_manager_01_create(physics_cloth_manager_01_t** out_ctx, const physics_cloth_manager_01_desc_t* desc);
int physics_cloth_manager_01_destroy(physics_cloth_manager_01_t* ctx);
...
int physics_cloth_manager_01_create_legacy(physics_cloth_manager_01_t* ctx, void* params);
int physics_cloth_manager_01_destroy_legacy(physics_cloth_manager_01_t* ctx, void* params);
...
#endif /* PHYSICS_CLOTH_MANAGER_01_H */
