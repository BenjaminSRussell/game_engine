/*
 * lighting_shadows_builder_05.h
 *
 * Header file for lighting_shadows_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LIGHTING_SHADOWS_BUILDER_05_H
#define LIGHTING_SHADOWS_BUILDER_05_H
...
typedef struct lighting_shadows_builder_05 lighting_shadows_builder_05_t;
typedef struct lighting_shadows_builder_05_desc lighting_shadows_builder_05_desc_t;
typedef struct lighting_shadows_builder_05_stats lighting_shadows_builder_05_stats_t;

/* Creation and destruction */
int lighting_shadows_builder_05_create(lighting_shadows_builder_05_t** out_ctx, const lighting_shadows_builder_05_desc_t* desc);
int lighting_shadows_builder_05_destroy(lighting_shadows_builder_05_t* ctx);
...
#endif /* LIGHTING_SHADOWS_BUILDER_05_H */
