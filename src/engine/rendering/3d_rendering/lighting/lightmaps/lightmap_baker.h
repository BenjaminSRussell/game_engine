...
#ifndef LIGHTING_LIGHTMAP_BAKER_H
#define LIGHTING_LIGHTMAP_BAKER_H
...
typedef struct lighting_lightmap_baker_handle {
    uint32_t id;
} lighting_lightmap_baker_handle_t;

typedef struct lighting_lightmap_baker_desc {
    uint32_t flags;
    void* user_data;
} lighting_lightmap_baker_desc_t;

typedef struct lighting_lightmap_baker_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} lighting_lightmap_baker_info_t;
...
#endif /* LIGHTING_LIGHTMAP_BAKER_H */
