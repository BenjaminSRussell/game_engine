/*
 * lighting_lightmaps_renderer_03.h
 *
 * Header file for lighting_lightmaps_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LIGHTING_LIGHTMAPS_RENDERER_03_H
#define LIGHTING_LIGHTMAPS_RENDERER_03_H
...
typedef struct lighting_lightmaps_renderer_03 lighting_lightmaps_renderer_03_t;
typedef struct lighting_lightmaps_renderer_03_desc lighting_lightmaps_renderer_03_desc_t;
typedef struct lighting_lightmaps_renderer_03_stats lighting_lightmaps_renderer_03_stats_t;

/* Creation and destruction */
int lighting_lightmaps_renderer_03_create(lighting_lightmaps_renderer_03_t** out_ctx, const lighting_lightmaps_renderer_03_desc_t* desc);
int lighting_lightmaps_renderer_03_destroy(lighting_lightmaps_renderer_03_t* ctx);
...
#endif /* LIGHTING_LIGHTMAPS_RENDERER_03_H */
