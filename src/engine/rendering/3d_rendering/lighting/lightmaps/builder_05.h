/*
 * lighting_lightmaps_builder_05.h
 *
 * Header file for lighting_lightmaps_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LIGHTING_LIGHTMAPS_BUILDER_05_H
#define LIGHTING_LIGHTMAPS_BUILDER_05_H
...
typedef struct lighting_lightmaps_builder_05 lighting_lightmaps_builder_05_t;
typedef struct lighting_lightmaps_builder_05_desc lighting_lightmaps_builder_05_desc_t;
typedef struct lighting_lightmaps_builder_05_stats lighting_lightmaps_builder_05_stats_t;

/* Creation and destruction */
int lighting_lightmaps_builder_05_create(lighting_lightmaps_builder_05_t** out_ctx, const lighting_lightmaps_builder_05_desc_t* desc);
int lighting_lightmaps_builder_05_destroy(lighting_lightmaps_builder_05_t* ctx);
...
#endif /* LIGHTING_LIGHTMAPS_BUILDER_05_H */
