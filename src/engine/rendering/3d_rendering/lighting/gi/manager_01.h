/*
 * lighting_gi_manager_01.h
 *
 * Header file for lighting_gi_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LIGHTING_GI_MANAGER_01_H
#define LIGHTING_GI_MANAGER_01_H
...
typedef struct lighting_gi_manager_01 lighting_gi_manager_01_t;
typedef struct lighting_gi_manager_01_desc lighting_gi_manager_01_desc_t;
typedef struct lighting_gi_manager_01_stats lighting_gi_manager_01_stats_t;

/* Creation and destruction */
int lighting_gi_manager_01_create(lighting_gi_manager_01_t** out_ctx, const lighting_gi_manager_01_desc_t* desc);
int lighting_gi_manager_01_destroy(lighting_gi_manager_01_t* ctx);
...
#endif /* LIGHTING_GI_MANAGER_01_H */
