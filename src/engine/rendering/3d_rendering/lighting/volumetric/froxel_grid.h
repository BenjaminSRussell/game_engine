...
/**
 * Converts screen-space coordinates (normalized [0,1]) and depth to froxel indices.
...
/**
 * Converts froxel indices to normalized screen coordinates [0,1] and view-space Z.
 */
