/*
 * lighting_volumetric_cache_06.h
 *
 * Header file for lighting_volumetric_cache_06 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LIGHTING_VOLUMETRIC_CACHE_06_H
#define LIGHTING_VOLUMETRIC_CACHE_06_H
...
typedef struct lighting_volumetric_cache_06 lighting_volumetric_cache_06_t;
typedef struct lighting_volumetric_cache_06_desc lighting_volumetric_cache_06_desc_t;
typedef struct lighting_volumetric_cache_06_stats lighting_volumetric_cache_06_stats_t;

/* Creation and destruction */
int lighting_volumetric_cache_06_create(lighting_volumetric_cache_06_t** out_ctx, const lighting_volumetric_cache_06_desc_t* desc);
int lighting_volumetric_cache_06_destroy(lighting_volumetric_cache_06_t* ctx);
...
#endif /* LIGHTING_VOLUMETRIC_CACHE_06_H */
