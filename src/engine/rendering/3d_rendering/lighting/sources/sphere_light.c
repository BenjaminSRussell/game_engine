 ...
 * TODO: Implement sphere light initialization
 * TODO: Add sphere light cleanup/shutdown
 * TODO: Implement sphere light validation
 * TODO: Add sphere light error handling
 * TODO: Implement sphere light serialization
 * TODO: Add sphere light debug output
 * TODO: Implement sphere light unit tests
 * TODO: Add sphere light performance counters
 * TODO: Implement sphere light hot-reload
 * TODO: Add sphere light thread safety
 * TODO: Implement sphere light memory pooling
 * TODO: Add sphere light caching layer
 * TODO: Implement sphere light async operations
 * TODO: Add sphere light GPU integration
 * TODO: Implement sphere light SIMD optimization
 * TODO: Add sphere light batch processing
 * TODO: Implement sphere light streaming support
 * TODO: Add sphere light LOD support
 * TODO: Implement sphere light culling integration
 * TODO: Add sphere light render graph node
 */
...
#define LIGHTING_SPHERE_LIGHT_MAX_COUNT 4096
#define LIGHTING_SPHERE_LIGHT_DEFAULT_CAPACITY 256
#define LIGHTING_SPHERE_LIGHT_ALIGNMENT 16
...
int lighting_sphere_light_init(void) {
    ...
    g_sphere_light_ctx.capacity = LIGHTING_SPHERE_LIGHT_DEFAULT_CAPACITY;
    g_sphere_light_ctx.items = calloc(g_sphere_light_ctx.capacity, sizeof(lighting_sphere_light_internal_t));
...
size_t lighting_sphere_light_get_memory_usage(void) {
    ...
    total += g_sphere_light_ctx.capacity * sizeof(lighting_sphere_light_internal_t);

    for (uint32_t i = 0; i < g_sphere_light_ctx.count; i++) {
        total += g_sphere_light_ctx.items[i].data_size;
    }
