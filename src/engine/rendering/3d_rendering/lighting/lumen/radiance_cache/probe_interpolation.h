...
#ifndef LUMEN_PROBE_INTERPOLATION_H
#define LUMEN_PROBE_INTERPOLATION_H
...
typedef struct lumen_probe_interpolation_handle {
    uint32_t id;
} lumen_probe_interpolation_handle_t;

typedef struct lumen_probe_interpolation_desc {
    uint32_t flags;
    void* user_data;
} lumen_probe_interpolation_desc_t;

typedef struct lumen_probe_interpolation_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} lumen_probe_interpolation_info_t;
...
#endif /* LUMEN_PROBE_INTERPOLATION_H */
