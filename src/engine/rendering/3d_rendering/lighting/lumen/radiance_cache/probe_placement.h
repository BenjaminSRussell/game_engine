...
#ifndef LUMEN_PROBE_PLACEMENT_H
#define LUMEN_PROBE_PLACEMENT_H
...
typedef struct lumen_probe_placement_handle {
    uint32_t id;
} lumen_probe_placement_handle_t;

typedef struct lumen_probe_placement_desc {
    uint32_t flags;
    void* user_data;
} lumen_probe_placement_desc_t;

typedef struct lumen_probe_placement_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} lumen_probe_placement_info_t;
