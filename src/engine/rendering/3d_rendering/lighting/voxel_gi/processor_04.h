/*
 * lighting_voxel_gi_processor_04.h
 *
 * Header file for lighting_voxel_gi_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LIGHTING_VOXEL_GI_PROCESSOR_04_H
#define LIGHTING_VOXEL_GI_PROCESSOR_04_H
...
typedef struct lighting_voxel_gi_processor_04 lighting_voxel_gi_processor_04_t;
typedef struct lighting_voxel_gi_processor_04_desc lighting_voxel_gi_processor_04_desc_t;
typedef struct lighting_voxel_gi_processor_04_stats lighting_voxel_gi_processor_04_stats_t;

/* Creation and destruction */
int lighting_voxel_gi_processor_04_create(lighting_voxel_gi_processor_04_t** out_ctx, const lighting_voxel_gi_processor_04_desc_t* desc);
int lighting_voxel_gi_processor_04_destroy(lighting_voxel_gi_processor_04_t* ctx);
...
#endif /* LIGHTING_VOXEL_GI_PROCESSOR_04_H */
