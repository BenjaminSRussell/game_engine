/*
 * editor_thumbnails_processor_04.h
 *
 * Header file for editor_thumbnails_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EDITOR_THUMBNAILS_PROCESSOR_04_H
#define EDITOR_THUMBNAILS_PROCESSOR_04_H
...
typedef struct editor_thumbnails_processor_04 editor_thumbnails_processor_04_t;
typedef struct editor_thumbnails_processor_04_desc editor_thumbnails_processor_04_desc_t;
typedef struct editor_thumbnails_processor_04_stats editor_thumbnails_processor_04_stats_t;

/* Creation and destruction */
int editor_thumbnails_processor_04_create(editor_thumbnails_processor_04_t** out_ctx, const editor_thumbnails_processor_04_desc_t* desc);
int editor_thumbnails_processor_04_destroy(editor_thumbnails_processor_04_t* ctx);
...
#endif /* EDITOR_THUMBNAILS_PROCESSOR_04_H */
