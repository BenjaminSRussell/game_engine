/*
 * editor_viewport_system_02.h
 *
 * Header file for editor_viewport_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EDITOR_VIEWPORT_SYSTEM_02_H
#define EDITOR_VIEWPORT_SYSTEM_02_H
...
typedef struct editor_viewport_system_02 editor_viewport_system_02_t;
typedef struct editor_viewport_system_02_desc editor_viewport_system_02_desc_t;
typedef struct editor_viewport_system_02_stats editor_viewport_system_02_stats_t;

/* Creation and destruction */
int editor_viewport_system_02_create(editor_viewport_system_02_t** out_ctx, const editor_viewport_system_02_desc_t* desc);
int editor_viewport_system_02_destroy(editor_viewport_system_02_t* ctx);
...
#endif /* EDITOR_VIEWPORT_SYSTEM_02_H */
