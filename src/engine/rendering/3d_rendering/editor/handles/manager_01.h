/*
 * editor_handles_manager_01.h
 *
 * Header file for editor_handles_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EDITOR_HANDLES_MANAGER_01_H
#define EDITOR_HANDLES_MANAGER_01_H
...
typedef struct editor_handles_manager_01 editor_handles_manager_01_t;
typedef struct editor_handles_manager_01_desc editor_handles_manager_01_desc_t;
typedef struct editor_handles_manager_01_stats editor_handles_manager_01_stats_t;

/* Creation and destruction */
int editor_handles_manager_01_create(editor_handles_manager_01_t** out_ctx, const editor_handles_manager_01_desc_t* desc);
int editor_handles_manager_01_destroy(editor_handles_manager_01_t* ctx);
...
#endif /* EDITOR_HANDLES_MANAGER_01_H */
