...
#ifndef UI_RENDERING_UI_ATLAS_H
#define UI_RENDERING_UI_ATLAS_H
...
typedef struct ui_rendering_ui_atlas_handle {
    uint32_t id;
} ui_rendering_ui_atlas_handle_t;

typedef struct ui_rendering_ui_atlas_desc {
    uint32_t flags;
    void* user_data;
} ui_rendering_ui_atlas_desc_t;

typedef struct ui_rendering_ui_atlas_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} ui_rendering_ui_atlas_info_t;
