/*
 * tools_conversion_processor_04.h
 *
 * Header file for tools_conversion_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef TOOLS_CONVERSION_PROCESSOR_04_H
#define TOOLS_CONVERSION_PROCESSOR_04_H
...
typedef struct tools_conversion_processor_04 tools_conversion_processor_04_t;
typedef struct tools_conversion_processor_04_desc tools_conversion_processor_04_desc_t;
typedef struct tools_conversion_processor_04_stats tools_conversion_processor_04_stats_t;

/* Creation and destruction */
int tools_conversion_processor_04_create(tools_conversion_processor_04_t** out_ctx, const tools_conversion_processor_04_desc_t* desc);
int tools_conversion_processor_04_destroy(tools_conversion_processor_04_t* ctx);
...
#endif /* TOOLS_CONVERSION_PROCESSOR_04_H */
