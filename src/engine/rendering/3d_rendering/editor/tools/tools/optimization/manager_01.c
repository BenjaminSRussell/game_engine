...
#include "rendering/3d_rendering/editor/tools/optimization/manager_01.h"
 ...
 * Complexity: O(n) where n is the number of elements
 */
int tools_optimization_manager_01_create(tools_optimization_manager_01_t* ctx, void* params) {
    if (!ctx) {
 ...
 * Complexity: O(n) where n is the number of elements
 */
int tools_optimization_manager_01_destroy(tools_optimization_manager_01_t* ctx, void* params) {
    if (!ctx) {
