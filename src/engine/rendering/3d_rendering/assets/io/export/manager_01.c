...
#include "rendering/3d_rendering/assets/io/export/manager_01.h"
...
int io_export_manager_01_get(io_export_manager_01_t* ctx, void* params) {
    if (!ctx) {
        // LOG_ERROR("io_export_manager_01_get: Invalid context");
        return -1;
    }
...
int io_export_manager_01_set(io_export_manager_01_t* ctx, void* params) {
    if (!ctx) {
        // LOG_ERROR("io_export_manager_01_set: Invalid context");
        return -1;
    }
...
int io_export_manager_01_reset(io_export_manager_01_t* ctx, void* params) {
    if (!ctx) {
        // LOG_ERROR("io_export_manager_01_reset: Invalid context");
        return -1;
    }
...
int io_export_manager_01_validate(io_export_manager_01_t* ctx, void* params) {
    if (!ctx) {
        // LOG_ERROR("io_export_manager_01_validate: Invalid context");
        return -1;
    }
...
int io_export_manager_01_flush(io_export_manager_01_t* ctx, void* params) {
    if (!ctx) {
        // LOG_ERROR("io_export_manager_01_flush: Invalid context");
        return -1;
    }
