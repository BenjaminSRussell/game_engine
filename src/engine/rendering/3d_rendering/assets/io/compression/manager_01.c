...
#include "rendering/3d_rendering/assets/io/compression/manager_01.h"
 ...
 * Complexity: O(n) where n is the number of elements
 */
int io_compression_manager_01_create(io_compression_manager_01_t* ctx, void* params) {
    if (!ctx) {
 ...
 * Complexity: O(n) where n is the number of elements
 */
int io_compression_manager_01_destroy(io_compression_manager_01_t* ctx, void* params) {
    if (!ctx) {
