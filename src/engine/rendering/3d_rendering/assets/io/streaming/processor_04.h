/*
 * io_streaming_processor_04.h
 *
 * Header file for io_streaming_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef IO_STREAMING_PROCESSOR_04_H
#define IO_STREAMING_PROCESSOR_04_H
...
typedef struct io_streaming_processor_04 io_streaming_processor_04_t;
typedef struct io_streaming_processor_04_desc io_streaming_processor_04_desc_t;
typedef struct io_streaming_processor_04_stats io_streaming_processor_04_stats_t;

/* Creation and destruction */
int io_streaming_processor_04_create(io_streaming_processor_04_t** out_ctx, const io_streaming_processor_04_desc_t* desc);
int io_streaming_processor_04_destroy(io_streaming_processor_04_t* ctx);
...
#endif /* IO_STREAMING_PROCESSOR_04_H */
