/*
 * io_caching_processor_04.h
 *
 * Header file for io_caching_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef IO_CACHING_PROCESSOR_04_H
#define IO_CACHING_PROCESSOR_04_H
...
typedef struct io_caching_processor_04 io_caching_processor_04_t;
typedef struct io_caching_processor_04_desc io_caching_processor_04_desc_t;
typedef struct io_caching_processor_04_stats io_caching_processor_04_stats_t;

/* Creation and destruction */
int io_caching_processor_04_create(io_caching_processor_04_t** out_ctx, const io_caching_processor_04_desc_t* desc);
int io_caching_processor_04_destroy(io_caching_processor_04_t* ctx);
...
#endif /* IO_CACHING_PROCESSOR_04_H */
