...
#ifndef TEXTURE_PAGE_PROVIDER_H
#define TEXTURE_PAGE_PROVIDER_H
...
typedef struct texture_page_provider_handle {
    uint32_t id;
} texture_page_provider_handle_t;

typedef struct texture_page_provider_desc {
    uint32_t flags;
    void* user_data;
} texture_page_provider_desc_t;

typedef struct texture_page_provider_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} texture_page_provider_info_t;
