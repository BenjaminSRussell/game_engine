...
#ifndef ASSET_SYSTEM_ANIMATION_COMPRESSION_H
#define ASSET_SYSTEM_ANIMATION_COMPRESSION_H
...
typedef struct asset_system_animation_compression_handle {
    uint32_t id;
} asset_system_animation_compression_handle_t;

typedef struct asset_system_animation_compression_desc {
    uint32_t flags;
    void* user_data;
} asset_system_animation_compression_desc_t;

typedef struct asset_system_animation_compression_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} asset_system_animation_compression_info_t;
...
#endif /* ASSET_SYSTEM_ANIMATION_COMPRESSION_H */
