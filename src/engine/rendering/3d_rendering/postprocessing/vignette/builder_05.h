/*
 * postprocessing_vignette_builder_05.h
 *
 * Header file for postprocessing_vignette_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef POSTPROCESSING_VIGNETTE_BUILDER_05_H
#define POSTPROCESSING_VIGNETTE_BUILDER_05_H
...
typedef struct postprocessing_vignette_builder_05 postprocessing_vignette_builder_05_t;
typedef struct postprocessing_vignette_builder_05_desc postprocessing_vignette_builder_05_desc_t;
typedef struct postprocessing_vignette_builder_05_stats postprocessing_vignette_builder_05_stats_t;

/* Creation and destruction */
int postprocessing_vignette_builder_05_create(postprocessing_vignette_builder_05_t** out_ctx, const postprocessing_vignette_builder_05_desc_t* desc);
int postprocessing_vignette_builder_05_destroy(postprocessing_vignette_builder_05_t* ctx);
...
#endif /* POSTPROCESSING_VIGNETTE_BUILDER_05_H */
