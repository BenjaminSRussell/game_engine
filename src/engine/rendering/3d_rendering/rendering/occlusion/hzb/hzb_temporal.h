...
#ifndef OCCLUSION_HZB_TEMPORAL_H
#define OCCLUSION_HZB_TEMPORAL_H
...
typedef struct occlusion_hzb_temporal_handle {
    uint32_t id;
} occlusion_hzb_temporal_handle_t;

typedef struct occlusion_hzb_temporal_desc {
    uint32_t flags;
    void* user_data;
} occlusion_hzb_temporal_desc_t;

typedef struct occlusion_hzb_temporal_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} occlusion_hzb_temporal_info_t;
...
#endif /* OCCLUSION_HZB_TEMPORAL_H */
