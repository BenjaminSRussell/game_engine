/*
 * rendering_clustered_processor_04.h
 *
 * Header file for rendering_clustered_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef RENDERING_CLUSTERED_PROCESSOR_04_H
#define RENDERING_CLUSTERED_PROCESSOR_04_H
...
typedef struct rendering_clustered_processor_04 rendering_clustered_processor_04_t;
typedef struct rendering_clustered_processor_04_desc rendering_clustered_processor_04_desc_t;
typedef struct rendering_clustered_processor_04_stats rendering_clustered_processor_04_stats_t;

/* Creation and destruction */
int rendering_clustered_processor_04_create(rendering_clustered_processor_04_t** out_ctx, const rendering_clustered_processor_04_desc_t* desc);
int rendering_clustered_processor_04_destroy(rendering_clustered_processor_04_t* ctx);
...
#endif /* RENDERING_CLUSTERED_PROCESSOR_04_H */
