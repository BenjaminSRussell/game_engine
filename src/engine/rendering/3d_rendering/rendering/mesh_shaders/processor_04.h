/*
 * rendering_mesh_shaders_processor_04.h
 *
 * Header file for rendering_mesh_shaders_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef RENDERING_MESH_SHADERS_PROCESSOR_04_H
#define RENDERING_MESH_SHADERS_PROCESSOR_04_H
...
typedef struct rendering_mesh_shaders_processor_04 rendering_mesh_shaders_processor_04_t;
typedef struct rendering_mesh_shaders_processor_04_desc rendering_mesh_shaders_processor_04_desc_t;
typedef struct rendering_mesh_shaders_processor_04_stats rendering_mesh_shaders_processor_04_stats_t;

/* Creation and destruction */
int rendering_mesh_shaders_processor_04_create(rendering_mesh_shaders_processor_04_t** out_ctx, const rendering_mesh_shaders_processor_04_desc_t* desc);
int rendering_mesh_shaders_processor_04_destroy(rendering_mesh_shaders_processor_04_t* ctx);
...
#endif /* RENDERING_MESH_SHADERS_PROCESSOR_04_H */
