/*
 * viewports_vr_renderer_03.h
 *
 * Header file for viewports_vr_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef VIEWPORTS_VR_RENDERER_03_H
#define VIEWPORTS_VR_RENDERER_03_H
...
typedef struct viewports_vr_renderer_03 viewports_vr_renderer_03_t;
typedef struct viewports_vr_renderer_03_desc viewports_vr_renderer_03_desc_t;
typedef struct viewports_vr_renderer_03_stats viewports_vr_renderer_03_stats_t;

/* Creation and destruction */
int viewports_vr_renderer_03_create(viewports_vr_renderer_03_t** out_ctx, const viewports_vr_renderer_03_desc_t* desc);
int viewports_vr_renderer_03_destroy(viewports_vr_renderer_03_t* ctx);
...
#endif /* VIEWPORTS_VR_RENDERER_03_H */
