/*
 * raytracing_hybrid_processor_04.h
 *
 * Header file for raytracing_hybrid_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef RAYTRACING_HYBRID_PROCESSOR_04_H
#define RAYTRACING_HYBRID_PROCESSOR_04_H
...
typedef struct raytracing_hybrid_processor_04 raytracing_hybrid_processor_04_t;
typedef struct raytracing_hybrid_processor_04_desc raytracing_hybrid_processor_04_desc_t;
typedef struct raytracing_hybrid_processor_04_stats raytracing_hybrid_processor_04_stats_t;

/* Creation and destruction */
int raytracing_hybrid_processor_04_create(raytracing_hybrid_processor_04_t** out_ctx, const raytracing_hybrid_processor_04_desc_t* desc);
int raytracing_hybrid_processor_04_destroy(raytracing_hybrid_processor_04_t* ctx);
...
#endif /* RAYTRACING_HYBRID_PROCESSOR_04_H */
