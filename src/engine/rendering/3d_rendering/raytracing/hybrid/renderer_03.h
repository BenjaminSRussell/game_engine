/*
 * raytracing_hybrid_renderer_03.h
 *
 * Header file for raytracing_hybrid_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef RAYTRACING_HYBRID_RENDERER_03_H
#define RAYTRACING_HYBRID_RENDERER_03_H
...
typedef struct raytracing_hybrid_renderer_03 raytracing_hybrid_renderer_03_t;
typedef struct raytracing_hybrid_renderer_03_desc raytracing_hybrid_renderer_03_desc_t;
typedef struct raytracing_hybrid_renderer_03_stats raytracing_hybrid_renderer_03_stats_t;

/* Creation and destruction */
int raytracing_hybrid_renderer_03_create(raytracing_hybrid_renderer_03_t** out_ctx, const raytracing_hybrid_renderer_03_desc_t* desc);
int raytracing_hybrid_renderer_03_destroy(raytracing_hybrid_renderer_03_t* ctx);
...
#endif /* RAYTRACING_HYBRID_RENDERER_03_H */
