/*
 * raytracing_acceleration_manager_01.h
 *
 * Header file for raytracing_acceleration_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef RAYTRACING_ACCELERATION_MANAGER_01_H
#define RAYTRACING_ACCELERATION_MANAGER_01_H
...
typedef struct raytracing_acceleration_manager_01 raytracing_acceleration_manager_01_t;
typedef struct raytracing_acceleration_manager_01_desc raytracing_acceleration_manager_01_desc_t;
typedef struct raytracing_acceleration_manager_01_stats raytracing_acceleration_manager_01_stats_t;

/* Creation and destruction */
int raytracing_acceleration_manager_01_create(raytracing_acceleration_manager_01_t** out_ctx, const raytracing_acceleration_manager_01_desc_t* desc);
int raytracing_acceleration_manager_01_destroy(raytracing_acceleration_manager_01_t* ctx);
...
#endif /* RAYTRACING_ACCELERATION_MANAGER_01_H */
