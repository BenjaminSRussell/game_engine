/*
 * materials_instances_builder_05.h
 *
 * Header file for materials_instances_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef MATERIALS_INSTANCES_BUILDER_05_H
#define MATERIALS_INSTANCES_BUILDER_05_H
...
typedef struct materials_instances_builder_05 materials_instances_builder_05_t;
typedef struct materials_instances_builder_05_desc materials_instances_builder_05_desc_t;
typedef struct materials_instances_builder_05_stats materials_instances_builder_05_stats_t;

/* Creation and destruction */
int materials_instances_builder_05_create(materials_instances_builder_05_t** out_ctx, const materials_instances_builder_05_desc_t* desc);
int materials_instances_builder_05_destroy(materials_instances_builder_05_t* ctx);
...
#endif /* MATERIALS_INSTANCES_BUILDER_05_H */
