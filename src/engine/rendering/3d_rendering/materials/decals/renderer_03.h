/*
 * materials_decals_renderer_03.h
 *
 * Header file for materials_decals_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef MATERIALS_DECALS_RENDERER_03_H
#define MATERIALS_DECALS_RENDERER_03_H
...
typedef struct materials_decals_renderer_03 materials_decals_renderer_03_t;
typedef struct materials_decals_renderer_03_desc materials_decals_renderer_03_desc_t;
typedef struct materials_decals_renderer_03_stats materials_decals_renderer_03_stats_t;

/* Creation and destruction */
int materials_decals_renderer_03_create(materials_decals_renderer_03_t** out_ctx, const materials_decals_renderer_03_desc_t* desc);
int materials_decals_renderer_03_destroy(materials_decals_renderer_03_t* ctx);
...
#endif /* MATERIALS_DECALS_RENDERER_03_H */
