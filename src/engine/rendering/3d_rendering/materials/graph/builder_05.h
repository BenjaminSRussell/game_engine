/*
 * materials_graph_builder_05.h
 *
 * Header file for materials_graph_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef MATERIALS_GRAPH_BUILDER_05_H
#define MATERIALS_GRAPH_BUILDER_05_H
...
typedef struct materials_graph_builder_05 materials_graph_builder_05_t;
typedef struct materials_graph_builder_05_desc materials_graph_builder_05_desc_t;
typedef struct materials_graph_builder_05_stats materials_graph_builder_05_stats_t;

/* Creation and destruction */
int materials_graph_builder_05_create(materials_graph_builder_05_t** out_ctx, const materials_graph_builder_05_desc_t* desc);
int materials_graph_builder_05_destroy(materials_graph_builder_05_t* ctx);
...
#endif /* MATERIALS_GRAPH_BUILDER_05_H */
