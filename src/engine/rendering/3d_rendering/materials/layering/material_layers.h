...
#ifndef MATERIALS_MATERIAL_LAYERS_H
#define MATERIALS_MATERIAL_LAYERS_H
...
typedef struct materials_material_layers_handle {
    uint32_t id;
} materials_material_layers_handle_t;

typedef struct materials_material_layers_desc {
    uint32_t flags;
    void* user_data;
} materials_material_layers_desc_t;

typedef struct materials_material_layers_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_material_layers_info_t;
...
#endif /* MATERIALS_MATERIAL_LAYERS_H */
