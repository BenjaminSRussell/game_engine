...
#ifndef MATERIALS_LAYER_WEIGHTS_H
#define MATERIALS_LAYER_WEIGHTS_H
...
typedef struct materials_layer_weights_handle {
    uint32_t id;
} materials_layer_weights_handle_t;

typedef struct materials_layer_weights_desc {
    uint32_t flags;
    void* user_data;
} materials_layer_weights_desc_t;

typedef struct materials_layer_weights_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_layer_weights_info_t;
...
#endif /* MATERIALS_LAYER_WEIGHTS_H */
