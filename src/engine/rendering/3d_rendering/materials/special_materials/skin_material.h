...
#ifndef MATERIALS_SKIN_MATERIAL_H
#define MATERIALS_SKIN_MATERIAL_H
...
typedef struct materials_skin_material_handle {
    uint32_t id;
} materials_skin_material_handle_t;

typedef struct materials_skin_material_desc {
    uint32_t flags;
    void* user_data;
} materials_skin_material_desc_t;

typedef struct materials_skin_material_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_skin_material_info_t;
...
#endif /* MATERIALS_SKIN_MATERIAL_H */
