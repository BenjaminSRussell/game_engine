/*
 * materials_cache_renderer_03.h
 *
 * Header file for materials_cache_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef MATERIALS_CACHE_RENDERER_03_H
#define MATERIALS_CACHE_RENDERER_03_H
...
typedef struct materials_cache_renderer_03 materials_cache_renderer_03_t;
typedef struct materials_cache_renderer_03_desc materials_cache_renderer_03_desc_t;
typedef struct materials_cache_renderer_03_stats materials_cache_renderer_03_stats_t;

/* Creation and destruction */
int materials_cache_renderer_03_create(materials_cache_renderer_03_t** out_ctx, const materials_cache_renderer_03_desc_t* desc);
int materials_cache_renderer_03_destroy(materials_cache_renderer_03_t* ctx);
...
#endif /* MATERIALS_CACHE_RENDERER_03_H */
