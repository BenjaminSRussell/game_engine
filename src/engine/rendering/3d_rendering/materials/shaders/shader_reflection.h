...
#ifndef MATERIALS_SHADER_REFLECTION_H
#define MATERIALS_SHADER_REFLECTION_H
...
typedef struct materials_shader_reflection_handle {
    uint32_t id;
} materials_shader_reflection_handle_t;

typedef struct materials_shader_reflection_desc {
    uint32_t flags;
    void* user_data;
} materials_shader_reflection_desc_t;

typedef struct materials_shader_reflection_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_shader_reflection_info_t;
...
#endif /* MATERIALS_SHADER_REFLECTION_H */
