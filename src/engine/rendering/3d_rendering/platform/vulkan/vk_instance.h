...
#ifndef PLATFORM_VK_INSTANCE_H
#define PLATFORM_VK_INSTANCE_H
...
typedef struct platform_vk_instance_handle {
    uint32_t id;
} platform_vk_instance_handle_t;

typedef struct platform_vk_instance_desc {
    uint32_t flags;
    void* user_data;
} platform_vk_instance_desc_t;

typedef struct platform_vk_instance_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} platform_vk_instance_info_t;
