/*
 * texture_arrays_processor_04.h
 *
 * Header file for texture_arrays_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef TEXTURE_ARRAYS_PROCESSOR_04_H
#define TEXTURE_ARRAYS_PROCESSOR_04_H
...
typedef struct texture_arrays_processor_04 texture_arrays_processor_04_t;
typedef struct texture_arrays_processor_04_desc texture_arrays_processor_04_desc_t;
typedef struct texture_arrays_processor_04_stats texture_arrays_processor_04_stats_t;

/* Creation and destruction */
int texture_arrays_processor_04_create(texture_arrays_processor_04_t** out_ctx, const texture_arrays_processor_04_desc_t* desc);
int texture_arrays_processor_04_destroy(texture_arrays_processor_04_t* ctx);
...
#endif /* TEXTURE_ARRAYS_PROCESSOR_04_H */
