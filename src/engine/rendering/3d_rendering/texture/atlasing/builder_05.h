/*
 * texture_atlasing_builder_05.h
 *
 * Header file for texture_atlasing_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef TEXTURE_ATLASING_BUILDER_05_H
#define TEXTURE_ATLASING_BUILDER_05_H
...
typedef struct texture_atlasing_builder_05 texture_atlasing_builder_05_t;
typedef struct texture_atlasing_builder_05_desc texture_atlasing_builder_05_desc_t;
typedef struct texture_atlasing_builder_05_stats texture_atlasing_builder_05_stats_t;

/* Creation and destruction */
int texture_atlasing_builder_05_create(texture_atlasing_builder_05_t** out_ctx, const texture_atlasing_builder_05_desc_t* desc);
int texture_atlasing_builder_05_destroy(texture_atlasing_builder_05_t* ctx);
...
#endif /* TEXTURE_ATLASING_BUILDER_05_H */
