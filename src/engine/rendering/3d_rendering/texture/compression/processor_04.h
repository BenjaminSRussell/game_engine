/*
 * texture_compression_processor_04.h
 *
 * Header file for texture_compression_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef TEXTURE_COMPRESSION_PROCESSOR_04_H
#define TEXTURE_COMPRESSION_PROCESSOR_04_H
...
typedef struct texture_compression_processor_04 texture_compression_processor_04_t;
typedef struct texture_compression_processor_04_desc texture_compression_processor_04_desc_t;
typedef struct texture_compression_processor_04_stats texture_compression_processor_04_stats_t;

/* Creation and destruction */
int texture_compression_processor_04_create(texture_compression_processor_04_t** out_ctx, const texture_compression_processor_04_desc_t* desc);
int texture_compression_processor_04_destroy(texture_compression_processor_04_t* ctx);
...
#endif /* TEXTURE_COMPRESSION_PROCESSOR_04_H */
