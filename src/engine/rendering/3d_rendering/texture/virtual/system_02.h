/*
 * texture_virtual_system_02.h
 *
 * Header file for texture_virtual_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef TEXTURE_VIRTUAL_SYSTEM_02_H
#define TEXTURE_VIRTUAL_SYSTEM_02_H
...
typedef struct texture_virtual_system_02 texture_virtual_system_02_t;
typedef struct texture_virtual_system_02_desc texture_virtual_system_02_desc_t;
typedef struct texture_virtual_system_02_stats texture_virtual_system_02_stats_t;

/* Creation and destruction */
int texture_virtual_system_02_create(texture_virtual_system_02_t** out_ctx, const texture_virtual_system_02_desc_t* desc);
int texture_virtual_system_02_destroy(texture_virtual_system_02_t* ctx);
...
#endif /* TEXTURE_VIRTUAL_SYSTEM_02_H */
