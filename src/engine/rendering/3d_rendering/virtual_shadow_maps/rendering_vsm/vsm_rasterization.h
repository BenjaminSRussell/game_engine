...
#ifndef VIRTUAL_SHADOW_MAPS_VSM_RASTERIZATION_H
#define VIRTUAL_SHADOW_MAPS_VSM_RASTERIZATION_H
...
typedef struct virtual_shadow_maps_vsm_rasterization_handle {
    uint32_t id;
} virtual_shadow_maps_vsm_rasterization_handle_t;

typedef struct virtual_shadow_maps_vsm_rasterization_desc {
    uint32_t flags;
    void* user_data;
} virtual_shadow_maps_vsm_rasterization_desc_t;

typedef struct virtual_shadow_maps_vsm_rasterization_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} virtual_shadow_maps_vsm_rasterization_info_t;
...
#endif /* VIRTUAL_SHADOW_MAPS_VSM_RASTERIZATION_H */
