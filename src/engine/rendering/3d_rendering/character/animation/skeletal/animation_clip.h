...
#ifndef ANIMATION_ANIMATION_CLIP_H
#define ANIMATION_ANIMATION_CLIP_H
...
typedef struct animation_animation_clip_handle {
    uint32_t id;
} animation_animation_clip_handle_t;

typedef struct animation_animation_clip_desc {
    uint32_t flags;
    void* user_data;
} animation_animation_clip_desc_t;

typedef struct animation_animation_clip_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} animation_animation_clip_info_t;
...
#endif /* ANIMATION_ANIMATION_CLIP_H */
