...
#ifndef HAIR_SYSTEM_HAIR_LOD_SIM_H
#define HAIR_SYSTEM_HAIR_LOD_SIM_H
...
typedef struct hair_system_hair_lod_sim_handle {
    uint32_t id;
} hair_system_hair_lod_sim_handle_t;

typedef struct hair_system_hair_lod_sim_desc {
    uint32_t flags;
    void* user_data;
} hair_system_hair_lod_sim_desc_t;

typedef struct hair_system_hair_lod_sim_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} hair_system_hair_lod_sim_info_t;
...
#endif /* HAIR_SYSTEM_HAIR_LOD_SIM_H */
