...
#ifndef HAIR_SYSTEM_HAIR_SHADOWS_RENDER_H
#define HAIR_SYSTEM_HAIR_SHADOWS_RENDER_H
...
typedef struct hair_system_hair_shadows_render_handle {
    uint32_t id;
} hair_system_hair_shadows_render_handle_t;

typedef struct hair_system_hair_shadows_render_desc {
    uint32_t flags;
    void* user_data;
} hair_system_hair_shadows_render_desc_t;

typedef struct hair_system_hair_shadows_render_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} hair_system_hair_shadows_render_info_t;
...
#endif /* HAIR_SYSTEM_HAIR_SHADOWS_RENDER_H */
