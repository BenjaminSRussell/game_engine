...
#ifndef HAIR_SYSTEM_HAIR_VISIBILITY_H
#define HAIR_SYSTEM_HAIR_VISIBILITY_H
...
typedef struct hair_system_hair_visibility_handle {
    uint32_t id;
} hair_system_hair_visibility_handle_t;

typedef struct hair_system_hair_visibility_desc {
    uint32_t flags;
    void* user_data;
} hair_system_hair_visibility_desc_t;

typedef struct hair_system_hair_visibility_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} hair_system_hair_visibility_info_t;
...
#endif /* HAIR_SYSTEM_HAIR_VISIBILITY_H */
