/*
 * animation_procedural_builder_05.h
 *
 * Header file for animation_procedural_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef ANIMATION_PROCEDURAL_BUILDER_05_H
#define ANIMATION_PROCEDURAL_BUILDER_05_H
...
typedef struct animation_procedural_builder_05 animation_procedural_builder_05_t;
typedef struct animation_procedural_builder_05_desc animation_procedural_builder_05_desc_t;
typedef struct animation_procedural_builder_05_stats animation_procedural_builder_05_stats_t;

/* Creation and destruction */
int animation_procedural_builder_05_create(animation_procedural_builder_05_t** out_ctx, const animation_procedural_builder_05_desc_t* desc);
int animation_procedural_builder_05_destroy(animation_procedural_builder_05_t* ctx);
...
#endif /* ANIMATION_PROCEDURAL_BUILDER_05_H */
