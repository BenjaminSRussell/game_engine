/*
 * animation_ragdoll_manager_01.h
 *
 * Header file for animation_ragdoll_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef ANIMATION_RAGDOLL_MANAGER_01_H
#define ANIMATION_RAGDOLL_MANAGER_01_H
...
typedef struct animation_ragdoll_manager_01 animation_ragdoll_manager_01_t;
typedef struct animation_ragdoll_manager_01_desc animation_ragdoll_manager_01_desc_t;
typedef struct animation_ragdoll_manager_01_stats animation_ragdoll_manager_01_stats_t;

/* Creation and destruction */
int animation_ragdoll_manager_01_create(animation_ragdoll_manager_01_t** out_ctx, const animation_ragdoll_manager_01_desc_t* desc);
int animation_ragdoll_manager_01_destroy(animation_ragdoll_manager_01_t* ctx);
...
#endif /* ANIMATION_RAGDOLL_MANAGER_01_H */
