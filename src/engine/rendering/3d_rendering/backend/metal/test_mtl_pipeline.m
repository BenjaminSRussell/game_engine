...
bool test_compute_pipeline_validation(void) {
  ...
  bool is_valid = metal_compute_pipeline_validate(
      device_ref, \u0026invalid_desc, error_msg, sizeof(error_msg));
...
bool test_shader_library_manager(void) {
  ...
  TEST_ASSERT(manager -\u003elibrary_count == 0,
              "Initial library count should be 0");
...
bool test_vertex_descriptor(void) {
  ...
  metal_vertex_descriptor_add_attribute(\u0026desc, 0,
  ...
  metal_vertex_descriptor_add_attribute(\u0026desc, 1,
