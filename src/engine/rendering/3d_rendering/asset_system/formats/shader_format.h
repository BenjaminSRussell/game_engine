...
#ifndef ASSET_SYSTEM_SHADER_FORMAT_H
#define ASSET_SYSTEM_SHADER_FORMAT_H
...
typedef struct asset_system_shader_format_handle {
    uint32_t id;
} asset_system_shader_format_handle_t;

typedef struct asset_system_shader_format_desc {
    uint32_t flags;
    void* user_data;
} asset_system_shader_format_desc_t;

typedef struct asset_system_shader_format_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} asset_system_shader_format_info_t;
...
#endif /* ASSET_SYSTEM_SHADER_FORMAT_H */
