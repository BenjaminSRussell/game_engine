...
#ifndef SCENE_MANAGEMENT_DYNAMIC_BATCHING_H
#define SCENE_MANAGEMENT_DYNAMIC_BATCHING_H
...
typedef struct scene_management_dynamic_batching_handle {
    uint32_t id;
} scene_management_dynamic_batching_handle_t;

typedef struct scene_management_dynamic_batching_desc {
    uint32_t flags;
    void* user_data;
} scene_management_dynamic_batching_desc_t;

typedef struct scene_management_dynamic_batching_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} scene_management_dynamic_batching_info_t;
...
#endif /* SCENE_MANAGEMENT_DYNAMIC_BATCHING_H */
