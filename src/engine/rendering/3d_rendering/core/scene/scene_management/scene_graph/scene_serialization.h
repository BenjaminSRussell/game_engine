...
#ifndef SCENE_MANAGEMENT_SCENE_SERIALIZATION_H
#define SCENE_MANAGEMENT_SCENE_SERIALIZATION_H
...
typedef struct scene_management_scene_serialization_handle {
    uint32_t id;
} scene_management_scene_serialization_handle_t;

typedef struct scene_management_scene_serialization_desc {
    uint32_t flags;
    void* user_data;
} scene_management_scene_serialization_desc_t;

typedef struct scene_management_scene_serialization_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} scene_management_scene_serialization_info_t;
...
#endif /* SCENE_MANAGEMENT_SCENE_SERIALIZATION_H */
