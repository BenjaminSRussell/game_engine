...
#ifndef SCENE_MANAGEMENT_STREAMING_DISTANCE_H
#define SCENE_MANAGEMENT_STREAMING_DISTANCE_H
...
typedef struct scene_management_streaming_distance_handle {
    uint32_t id;
} scene_management_streaming_distance_handle_t;

typedef struct scene_management_streaming_distance_desc {
    uint32_t flags;
    void* user_data;
} scene_management_streaming_distance_desc_t;

typedef struct scene_management_streaming_distance_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} scene_management_streaming_distance_info_t;
...
#endif /* SCENE_MANAGEMENT_STREAMING_DISTANCE_H */
