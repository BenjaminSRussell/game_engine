...
#ifndef SCENE_MANAGEMENT_PARTITION_GRID_H
#define SCENE_MANAGEMENT_PARTITION_GRID_H
...
typedef struct scene_management_partition_grid_handle {
    uint32_t id;
} scene_management_partition_grid_handle_t;

typedef struct scene_management_partition_grid_desc {
    uint32_t flags;
    void* user_data;
} scene_management_partition_grid_desc_t;

typedef struct scene_management_partition_grid_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} scene_management_partition_grid_info_t;
...
#endif /* SCENE_MANAGEMENT_PARTITION_GRID_H */
