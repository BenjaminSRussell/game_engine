...
#ifndef CORE_DEVICE_QUEUE_FAMILIES_H
#define CORE_DEVICE_QUEUE_FAMILIES_H
...
typedef struct core_device_queue_families_handle {
    uint32_t id;
} core_device_queue_families_handle_t;

typedef struct core_device_queue_families_desc {
    uint32_t flags;
    void* user_data;
} core_device_queue_families_desc_t;

typedef struct core_device_queue_families_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} core_device_queue_families_info_t;
...
#endif /* CORE_DEVICE_QUEUE_FAMILIES_H */
