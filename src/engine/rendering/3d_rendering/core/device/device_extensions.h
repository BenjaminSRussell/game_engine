...
#ifndef CORE_DEVICE_EXTENSIONS_H
#define CORE_DEVICE_EXTENSIONS_H
...
typedef struct core_device_extensions_handle {
    uint32_t id;
} core_device_extensions_handle_t;

typedef struct core_device_extensions_desc {
    uint32_t flags;
    void* user_data;
} core_device_extensions_desc_t;

typedef struct core_device_extensions_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} core_device_extensions_info_t;
...
#endif /* CORE_DEVICE_EXTENSIONS_H */
