/*
 * core_queue_cache_06.h
 *
 * Header file for core_queue_cache_06 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef CORE_QUEUE_CACHE_06_H
#define CORE_QUEUE_CACHE_06_H
...
typedef struct core_queue_cache_06 core_queue_cache_06_t;
typedef struct core_queue_cache_06_desc core_queue_cache_06_desc_t;
typedef struct core_queue_cache_06_stats core_queue_cache_06_stats_t;

/* Creation and destruction */
int core_queue_cache_06_create(core_queue_cache_06_t** out_ctx, const core_queue_cache_06_desc_t* desc);
int core_queue_cache_06_destroy(core_queue_cache_06_t* ctx);
