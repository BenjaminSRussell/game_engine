/*
 * core_queue_renderer_03.h
 *
 * Header file for core_queue_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef CORE_QUEUE_RENDERER_03_H
#define CORE_QUEUE_RENDERER_03_H
...
typedef struct core_queue_renderer_03 core_queue_renderer_03_t;
typedef struct core_queue_renderer_03_desc core_queue_renderer_03_desc_t;
typedef struct core_queue_renderer_03_stats core_queue_renderer_03_stats_t;

/* Creation and destruction */
int core_queue_renderer_03_create(core_queue_renderer_03_t** out_ctx, const core_queue_renderer_03_desc_t* desc);
int core_queue_renderer_03_destroy(core_queue_renderer_03_t* ctx);
...
#endif /* CORE_QUEUE_RENDERER_03_H */
