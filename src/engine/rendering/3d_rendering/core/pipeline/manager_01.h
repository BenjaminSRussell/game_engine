/*
 * core_pipeline_manager_01.h
 *
 * Header file for core_pipeline_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef CORE_PIPELINE_MANAGER_01_H
#define CORE_PIPELINE_MANAGER_01_H
...
typedef struct core_pipeline_manager_01 core_pipeline_manager_01_t;
typedef struct core_pipeline_manager_01_desc core_pipeline_manager_01_desc_t;
typedef struct core_pipeline_manager_01_stats core_pipeline_manager_01_stats_t;

/* Creation and destruction */
int core_pipeline_manager_01_create(core_pipeline_manager_01_t** out_ctx, const core_pipeline_manager_01_desc_t* desc);
int core_pipeline_manager_01_destroy(core_pipeline_manager_01_t* ctx);
...
#endif /* CORE_PIPELINE_MANAGER_01_H */
