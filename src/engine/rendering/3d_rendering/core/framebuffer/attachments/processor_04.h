/*
 * framebuffer_attachments_processor_04.h
 *
 * Header file for framebuffer_attachments_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef FRAMEBUFFER_ATTACHMENTS_PROCESSOR_04_H
#define FRAMEBUFFER_ATTACHMENTS_PROCESSOR_04_H
...
typedef struct framebuffer_attachments_processor_04 framebuffer_attachments_processor_04_t;
typedef struct framebuffer_attachments_processor_04_desc framebuffer_attachments_processor_04_desc_t;
typedef struct framebuffer_attachments_processor_04_stats framebuffer_attachments_processor_04_stats_t;

/* Creation and destruction */
int framebuffer_attachments_processor_04_create(framebuffer_attachments_processor_04_t** out_ctx, const framebuffer_attachments_processor_04_desc_t* desc);
int framebuffer_attachments_processor_04_destroy(framebuffer_attachments_processor_04_t* ctx);
...
#endif /* FRAMEBUFFER_ATTACHMENTS_PROCESSOR_04_H */
