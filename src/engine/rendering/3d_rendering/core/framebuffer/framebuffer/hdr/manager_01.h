/*
 * framebuffer_hdr_manager_01.h
 *
 * Header file for framebuffer_hdr_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef FRAMEBUFFER_HDR_MANAGER_01_H
#define FRAMEBUFFER_HDR_MANAGER_01_H
...
typedef struct framebuffer_hdr_manager_01 framebuffer_hdr_manager_01_t;
typedef struct framebuffer_hdr_manager_01_desc framebuffer_hdr_manager_01_desc_t;
typedef struct framebuffer_hdr_manager_01_stats framebuffer_hdr_manager_01_stats_t;

/* Creation and destruction */
int framebuffer_hdr_manager_01_create(framebuffer_hdr_manager_01_t** out_ctx, const framebuffer_hdr_manager_01_desc_t* desc);
int framebuffer_hdr_manager_01_destroy(framebuffer_hdr_manager_01_t* ctx);
...
#endif /* FRAMEBUFFER_HDR_MANAGER_01_H */
