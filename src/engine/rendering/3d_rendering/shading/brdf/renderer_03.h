/*
 * shading_brdf_renderer_03.h
 *
 * Header file for shading_brdf_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef SHADING_BRDF_RENDERER_03_H
#define SHADING_BRDF_RENDERER_03_H
...
typedef struct shading_brdf_renderer_03 shading_brdf_renderer_03_t;
typedef struct shading_brdf_renderer_03_desc shading_brdf_renderer_03_desc_t;
typedef struct shading_brdf_renderer_03_stats shading_brdf_renderer_03_stats_t;

/* Creation and destruction */
int shading_brdf_renderer_03_create(shading_brdf_renderer_03_t** out_ctx, const shading_brdf_renderer_03_desc_t* desc);
int shading_brdf_renderer_03_destroy(shading_brdf_renderer_03_t* ctx);
...
#endif /* SHADING_BRDF_RENDERER_03_H */
