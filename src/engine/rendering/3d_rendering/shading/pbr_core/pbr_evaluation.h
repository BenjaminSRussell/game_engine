/**
 * @file pbr_evaluation.h
 * @brief PBR material evaluation
 *
 * TODO: Complete implementation
  * TODO: Specular evaluation
 * TODO: Diffuse evaluation
 */

#ifndef RENDER_PBR_EVALUATION_H
#define RENDER_PBR_EVALUATION_H
