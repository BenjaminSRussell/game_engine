/*
 * shading_clearcoat_manager_01.h
 *
 * Header file for shading_clearcoat_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef SHADING_CLEARCOAT_MANAGER_01_H
#define SHADING_CLEARCOAT_MANAGER_01_H
...
typedef struct shading_clearcoat_manager_01 shading_clearcoat_manager_01_t;
typedef struct shading_clearcoat_manager_01_desc shading_clearcoat_manager_01_desc_t;
typedef struct shading_clearcoat_manager_01_stats shading_clearcoat_manager_01_stats_t;

/* Creation and destruction */
int shading_clearcoat_manager_01_create(shading_clearcoat_manager_01_t** out_ctx, const shading_clearcoat_manager_01_desc_t* desc);
int shading_clearcoat_manager_01_destroy(shading_clearcoat_manager_01_t* ctx);
...
#endif /* SHADING_CLEARCOAT_MANAGER_01_H */
