...
#ifndef SHADING_SSS_PROFILE_H
#define SHADING_SSS_PROFILE_H
...
typedef struct shading_sss_profile_handle {
    uint32_t id;
} shading_sss_profile_handle_t;

typedef struct shading_sss_profile_desc {
    uint32_t flags;
    void* user_data;
} shading_sss_profile_desc_t;

typedef struct shading_sss_profile_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shading_sss_profile_info_t;
