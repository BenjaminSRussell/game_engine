/*
 * shading_anisotropic_system_02.h
 *
 * Header file for shading_anisotropic_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef SHADING_ANISOTROPIC_SYSTEM_02_H
#define SHADING_ANISOTROPIC_SYSTEM_02_H
...
typedef struct shading_anisotropic_system_02 shading_anisotropic_system_02_t;
typedef struct shading_anisotropic_system_02_desc shading_anisotropic_system_02_desc_t;
typedef struct shading_anisotropic_system_02_stats shading_anisotropic_system_02_stats_t;

/* Creation and destruction */
int shading_anisotropic_system_02_create(shading_anisotropic_system_02_t** out_ctx, const shading_anisotropic_system_02_desc_t* desc);
int shading_anisotropic_system_02_destroy(shading_anisotropic_system_02_t* ctx);
...
#endif /* SHADING_ANISOTROPIC_SYSTEM_02_H */
