/*
 * shading_diffuse_manager_01.h
 *
 * Header file for shading_diffuse_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef SHADING_DIFFUSE_MANAGER_01_H
#define SHADING_DIFFUSE_MANAGER_01_H
...
typedef struct shading_diffuse_manager_01 shading_diffuse_manager_01_t;
typedef struct shading_diffuse_manager_01_desc shading_diffuse_manager_01_desc_t;
typedef struct shading_diffuse_manager_01_stats shading_diffuse_manager_01_stats_t;

/* Creation and destruction */
int shading_diffuse_manager_01_create(shading_diffuse_manager_01_t** out_ctx, const shading_diffuse_manager_01_desc_t* desc);
int shading_diffuse_manager_01_destroy(shading_diffuse_manager_01_t* ctx);
...
#endif /* SHADING_DIFFUSE_MANAGER_01_H */
