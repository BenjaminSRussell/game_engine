/*
 * shading_iridescence_system_02.h
 *
 * Header file for shading_iridescence_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef SHADING_IRIDESCENCE_SYSTEM_02_H
#define SHADING_IRIDESCENCE_SYSTEM_02_H
...
typedef struct shading_iridescence_system_02 shading_iridescence_system_02_t;
typedef struct shading_iridescence_system_02_desc shading_iridescence_system_02_desc_t;
typedef struct shading_iridescence_system_02_stats shading_iridescence_system_02_stats_t;

/* Creation and destruction */
int shading_iridescence_system_02_create(shading_iridescence_system_02_t** out_ctx, const shading_iridescence_system_02_desc_t* desc);
int shading_iridescence_system_02_destroy(shading_iridescence_system_02_t* ctx);
...
#endif /* SHADING_IRIDESCENCE_SYSTEM_02_H */
