...
SUBSYSTEMS = {
    ...
    "nanite": {
        "cluster": [
            ("cluster_builder", "Mesh cluster generation"),
            ("cluster_dag", "Cluster DAG construction"),
            ("cluster_bounds", "Cluster bounding volumes"),
            ("cluster_lod", "Cluster LOD selection"),
            ("cluster_merge", "Cluster merging"),
            ("cluster_split", "Cluster splitting"),
        ],
        "streaming": [
            ("nanite_streamer", "Nanite data streaming"),
            ("page_cache", "Cluster page caching"),
            ("residency_manager", "Memory residency"),
            ("stream_priority", "Streaming priority"),
            ("prefetch", "Cluster prefetching"),
            ("eviction", "Page eviction policy"),
        ],
        "culling_nanite": [
            ("cluster_cull_gpu", "GPU cluster culling"),
            ("triangle_cull", "Triangle-level culling"),
            ("two_pass_cull", "Two-pass occlusion"),
            ("persistent_cull", "Persistent culling"),
            ("cull_feedback", "Culling feedback"),
            ("visibility_buffer_nanite", "Visibility buffer integration"),
        ],
        "rendering_nanite": [
            ("software_raster", "Software rasterization"),
            ("hardware_raster", "Hardware rasterization path"),
            ("material_eval", "Material evaluation"),
            ("depth_only", "Depth-only pass"),
            ("shadow_pass", "Shadow rendering pass"),
            ("feedback_analysis", "Rendering feedback"),
        ],
    },
    "lumen": {
        "surface_cache": [
            ("surface_atlas", "Surface cache atlas"),
            ("surface_card", "Surface card generation"),
            ("surface_capture", "Surface light capture"),
            ("surface_update", "Surface cache updates"),
            ("card_placement", "Card placement strategy"),
            ("surface_lod", "Surface cache LOD"),
        ],
        "radiance_cache": [
            ("probe_octahedron", "Octahedral probe encoding"),
            ("probe_placement", "Probe placement"),
            ("probe_interpolation", "Probe interpolation"),
            ("radiance_inject", "Radiance injection"),
            ("radiance_update", "Radiance cache update"),
            ("cascade_radiance", "Cascaded radiance"),
        ],
        "tracing_lumen": [
            ("screen_trace", "Screen-space tracing"),
            ("software_trace", "Software ray tracing"),
            ("hybrid_trace", "Hybrid trace selection"),
            ("trace_dispatch", "Trace dispatch"),
            ("hit_lighting", "Hit point lighting"),
            ("trace_cache", "Trace result caching"),
        ],
        "final_gather": [
            ("final_gather_rays", "Final gather rays"),
            ("gather_integration", "Gather integration"),
            ("temporal_blend", "Temporal blending"),
            ("history_rejection", "History rejection"),
            ("denoise_lumen", "Lumen denoising"),
            ("diffuse_indirect", "Diffuse indirect lighting"),
        ],
    },
    "virtual_shadow_maps": {
        "page_management": [
            ("vsm_page_table", "VSM page table"),
            ("vsm_page_pool", "VSM page pool"),
            ("vsm_allocation", "Page allocation"),
            ("vsm_invalidation", "Page invalidation"),
            ("vsm_caching", "Shadow page caching"),
            ("vsm_compression", "Page compression"),
        ],
        "rendering_vsm": [
            ("vsm_culling", "VSM culling"),
            ("vsm_rasterization", "Page rasterization"),
            ("vsm_clipmap", "Clipmap management"),
            ("vsm_projection", "Shadow projection"),
            ("vsm_sampling", "Shadow sampling"),
            ("vsm_filtering", "Shadow filtering"),
        ],
    },
    "hair_system": {
        "simulation": [
            ("hair_strand", "Hair strand representation"),
            ("hair_physics", "Hair physics simulation"),
            ("hair_collision", "Hair collision"),
            ("hair_forces", "Hair force application"),
            ("hair_constraints", "Hair constraints"),
            ("hair_lod_sim", "Simulation LOD"),
        ],
        "rendering_hair": [
            ("hair_visibility", "Hair visibility"),
            ("hair_shading_render", "Hair shading"),
            ("hair_shadows_render", "Hair shadow casting"),
            ("hair_antialiasing_render", "Hair anti-aliasing"),
            ("hair_ordering", "Hair ordering"),
            ("hair_tessellation", "Hair tessellation"),
        ],
    },
    "cloth_system": {
        "simulation_cloth": [
            ("cloth_mesh", "Cloth mesh representation"),
            ("cloth_physics", "Cloth physics solver"),
            ("cloth_collision", "Cloth collision"),
            ("cloth_constraints", "Cloth constraints"),
            ("cloth_wind", "Wind forces"),
            ("cloth_tearing", "Cloth tearing"),
        ],
        "rendering_cloth": [
            ("cloth_normals", "Cloth normal computation"),
            ("cloth_tangents", "Cloth tangent space"),
            ("cloth_shading", "Cloth shading"),
            ("cloth_shadows", "Cloth shadows"),
            ("cloth_double_sided", "Double-sided rendering"),
            ("cloth_thickness", "Cloth thickness"),
        ],
    },
    "destruction": {
        "fracture": [
            ("fracture_pattern", "Fracture pattern generation"),
            ("voronoi_fracture", "Voronoi fracturing"),
            ("runtime_fracture", "Runtime fracturing"),
            ("debris_system", "Debris generation"),
            ("fracture_mesh", "Fracture mesh generation"),
            ("fracture_physics", "Fracture physics"),
        ],
        "rendering_destruction": [
            ("destruction_mesh", "Destruction mesh rendering"),
            ("dust_effects", "Dust/smoke effects"),
            ("debris_rendering", "Debris rendering"),
            ("damage_decals", "Damage decals"),
            ("crack_rendering", "Crack rendering"),
            ("destruction_lod", "Destruction LOD"),
        ],
    },
    "scene_management": {
        "world_partition": [
            ("world_partition", "World partitioning"),
            ("streaming_levels", "Level streaming"),
            ("cell_loading", "Cell loading/unloading"),
            ("streaming_distance", "Streaming distances"),
            ("level_bounds", "Level bounds"),
            ("partition_grid", "Partition grid"),
        ],
        "scene_graph": [
            ("scene_node", "Scene node hierarchy"),
            ("transform_hierarchy", "Transform hierarchy"),
            ("scene_update", "Scene update"),
            ("visibility_hierarchy", "Visibility hierarchy"),
            ("scene_query", "Scene queries"),
            ("scene_serialization", "Scene serialization"),
        ],
        "batching": [
            ("static_batching", "Static batching"),
            ("dynamic_batching", "Dynamic batching"),
            ("material_batching", "Material-based batching"),
            ("instance_batching", "Instance batching"),
            ("batch_breaking", "Batch breaking"),
            ("batch_statistics", "Batch statistics"),
        ],
    },
    "asset_system": {
        "loading": [
            ("asset_loader", "Asset loading system"),
            ("async_loading", "Async asset loading"),
            ("asset_dependencies", "Asset dependencies"),
            ("asset_refs", "Asset references"),
            ("asset_hot_reload", "Hot reload support"),
            ("asset_validation", "Asset validation"),
        ],
        "formats": [
            ("mesh_format", "Mesh file format"),
            ("texture_format", "Texture file format"),
            ("material_format", "Material file format"),
            ("animation_format", "Animation file format"),
            ("scene_format", "Scene file format"),
            ("shader_format", "Shader file format"),
        ],
        "import": [
            ("gltf_importer", "glTF importer"),
            ("fbx_importer", "FBX importer"),
            ("obj_importer", "OBJ importer"),
            ("texture_importer", "Texture importer"),
            ("material_importer", "Material importer"),
            ("animation_importer", "Animation importer"),
        ],
        "compression_assets": [
            ("mesh_compression", "Mesh compression"),
            ("texture_compression_assets", "Texture compression"),
            ("animation_compression", "Animation compression"),
            ("asset_bundling", "Asset bundling"),
            ("asset_streaming", "Asset streaming"),
    ...
    "platform": {
        "vulkan": [
            ...
            ("vk_swapchain", "Vulkan swapchain"),
            ("vk_command", "Vulkan commands"),
            ("vk_pipeline", "Vulkan pipelines"),
            ("vk_descriptor", "Vulkan descriptors"),
            ("vk_memory", "Vulkan memory"),
            ("vk_sync", "Vulkan synchronization"),
        ],
        "metal": [
            ("mtl_device", "Metal device"),
            ("mtl_command", "Metal command encoding"),
            ("mtl_pipeline", "Metal pipelines"),
            ("mtl_buffer", "Metal buffers"),
            ("mtl_texture", "Metal textures"),
            ("mtl_sampler", "Metal samplers"),
        ],
        "d3d12": [
            ("dx_device", "D3D12 device"),
            ("dx_command_list", "D3D12 command lists"),
            ("dx_pipeline", "D3D12 pipelines"),
            ("dx_root_signature", "D3D12 root signatures"),
            ("dx_heap", "D3D12 heaps"),
            ("dx_descriptor", "D3D12 descriptors"),
        ],
    },
    "occlusion": {
        "software_occlusion": [
            ("sw_rasterizer", "Software rasterizer"),
            ("sw_depth_buffer", "Software depth buffer"),
            ("sw_triangle", "Software triangle raster"),
            ("sw_binning", "Tile binning"),
            ("masked_occlusion", "Masked occlusion culling"),
            ("occlusion_query", "Occlusion query"),
        ],
        "hzb": [
            ("hzb_build", "HZB pyramid building"),
            ("hzb_downsample", "HZB downsampling"),
            ("hzb_test", "HZB visibility test"),
            ("hzb_temporal", "Temporal HZB"),
            ("hzb_first_person", "First-person HZB"),
            ("hzb_debug", "HZB debugging"),
        ],
    },
    "shadows_advanced": {
        "ray_traced_shadows": [
            ("rt_shadow_ray", "RT shadow ray generation"),
            ("rt_shadow_denoise", "RT shadow denoising"),
            ("rt_penumbra", "RT soft penumbra"),
            ("rt_area_shadow", "RT area light shadows"),
            ("rt_shadow_cache", "RT shadow caching"),
            ("rt_shadow_lod", "RT shadow LOD"),
        ],
        "shadow_techniques": [
            ("moment_shadow", "Moment shadow maps"),
            ("sdsm", "Sample distribution shadows"),
            ("contact_shadows_adv", "Contact shadows"),
            ("capsule_shadows", "Capsule shadows"),
            ("sdf_shadows", "SDF shadows"),
            ("hybrid_shadows", "Hybrid shadow system"),
        ],
    },
    "vrs": {
        "vrs_analysis": [
            ("motion_vrs", "Motion-based VRS"),
            ("edge_vrs", "Edge-based VRS"),
            ("luminance_vrs", "Luminance-based VRS"),
            ("depth_vrs", "Depth-based VRS"),
            ("content_adaptive", "Content adaptive VRS"),
            ("vrs_debug", "VRS visualization"),
        ],
        "vrs_rendering": [
            ("vrs_image", "VRS image generation"),
            ("vrs_combiner", "VRS combiner"),
            ("per_draw_vrs", "Per-draw VRS"),
            ("per_primitive_vrs", "Per-primitive VRS"),
            ("vrs_quality", "VRS quality modes"),
            ("vrs_integration", "VRS pipeline integration"),
        ],
    },
}
