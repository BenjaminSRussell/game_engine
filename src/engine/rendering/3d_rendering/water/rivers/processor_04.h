/*
 * water_rivers_processor_04.h
 *
 * Header file for water_rivers_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef WATER_RIVERS_PROCESSOR_04_H
#define WATER_RIVERS_PROCESSOR_04_H
...
typedef struct water_rivers_processor_04 water_rivers_processor_04_t;
typedef struct water_rivers_processor_04_desc water_rivers_processor_04_desc_t;
typedef struct water_rivers_processor_04_stats water_rivers_processor_04_stats_t;

/* Creation and destruction */
int water_rivers_processor_04_create(water_rivers_processor_04_t** out_ctx, const water_rivers_processor_04_desc_t* desc);
int water_rivers_processor_04_destroy(water_rivers_processor_04_t* ctx);
...
#endif /* WATER_RIVERS_PROCESSOR_04_H */
