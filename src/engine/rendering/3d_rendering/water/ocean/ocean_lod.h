...
/* Operations */
int water_ocean_lod_update(water_ocean_lod_handle_t handle, Vec3 camera_pos);
uint32_t water_ocean_lod_get_level(water_ocean_lod_handle_t handle, Vec3 world_pos, Vec3 camera_pos);
