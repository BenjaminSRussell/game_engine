/*
 * water_underwater_builder_05.h
 *
 * Header file for water_underwater_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef WATER_UNDERWATER_BUILDER_05_H
#define WATER_UNDERWATER_BUILDER_05_H
...
typedef struct water_underwater_builder_05 water_underwater_builder_05_t;
typedef struct water_underwater_builder_05_desc water_underwater_builder_05_desc_t;
typedef struct water_underwater_builder_05_stats water_underwater_builder_05_stats_t;

/* Creation and destruction */
int water_underwater_builder_05_create(water_underwater_builder_05_t** out_ctx, const water_underwater_builder_05_desc_t* desc);
int water_underwater_builder_05_destroy(water_underwater_builder_05_t* ctx);
...
#endif /* WATER_UNDERWATER_BUILDER_05_H */
