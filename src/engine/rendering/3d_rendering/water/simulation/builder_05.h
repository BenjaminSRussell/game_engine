/*
 * water_simulation_builder_05.h
 *
 * Header file for water_simulation_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef WATER_SIMULATION_BUILDER_05_H
#define WATER_SIMULATION_BUILDER_05_H
...
typedef struct water_simulation_builder_05 water_simulation_builder_05_t;
typedef struct water_simulation_builder_05_desc water_simulation_builder_05_desc_t;
typedef struct water_simulation_builder_05_stats water_simulation_builder_05_stats_t;

/* Creation and destruction */
int water_simulation_builder_05_create(water_simulation_builder_05_t** out_ctx, const water_simulation_builder_05_desc_t* desc);
int water_simulation_builder_05_destroy(water_simulation_builder_05_t* ctx);
...
#endif /* WATER_SIMULATION_BUILDER_05_H */
