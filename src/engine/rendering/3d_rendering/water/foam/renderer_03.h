/*
 * water_foam_renderer_03.h
 *
 * Header file for water_foam_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef WATER_FOAM_RENDERER_03_H
#define WATER_FOAM_RENDERER_03_H
...
typedef struct water_foam_renderer_03 water_foam_renderer_03_t;
typedef struct water_foam_renderer_03_desc water_foam_renderer_03_desc_t;
typedef struct water_foam_renderer_03_stats water_foam_renderer_03_stats_t;

/* Creation and destruction */
int water_foam_renderer_03_create(water_foam_renderer_03_t** out_ctx, const water_foam_renderer_03_desc_t* desc);
int water_foam_renderer_03_destroy(water_foam_renderer_03_t* ctx);
...
#endif /* WATER_FOAM_RENDERER_03_H */
