/*
 * geometry_vertex_manager_01.h
 *
 * Header file for geometry_vertex_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef GEOMETRY_VERTEX_MANAGER_01_H
#define GEOMETRY_VERTEX_MANAGER_01_H
...
typedef struct geometry_vertex_manager_01 geometry_vertex_manager_01_t;
typedef struct geometry_vertex_manager_01_desc geometry_vertex_manager_01_desc_t;
typedef struct geometry_vertex_manager_01_stats geometry_vertex_manager_01_stats_t;

/* Creation and destruction */
int geometry_vertex_manager_01_create(geometry_vertex_manager_01_t** out_ctx, const geometry_vertex_manager_01_desc_t* desc);
int geometry_vertex_manager_01_destroy(geometry_vertex_manager_01_t* ctx);
...
#endif /* GEOMETRY_VERTEX_MANAGER_01_H */
