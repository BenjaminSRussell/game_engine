/*
 * geometry_bvh_manager_01.h
 *
 * Header file for geometry_bvh_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef GEOMETRY_BVH_MANAGER_01_H
#define GEOMETRY_BVH_MANAGER_01_H
...
typedef struct geometry_bvh_manager_01 geometry_bvh_manager_01_t;
typedef struct geometry_bvh_manager_01_desc geometry_bvh_manager_01_desc_t;
typedef struct geometry_bvh_manager_01_stats geometry_bvh_manager_01_stats_t;

/* Creation and destruction */
int geometry_bvh_manager_01_create(geometry_bvh_manager_01_t** out_ctx, const geometry_bvh_manager_01_desc_t* desc);
int geometry_bvh_manager_01_destroy(geometry_bvh_manager_01_t* ctx);
...
#endif /* GEOMETRY_BVH_MANAGER_01_H */
