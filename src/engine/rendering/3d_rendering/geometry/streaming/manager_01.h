/*
 * geometry_streaming_manager_01.h
 *
 * Header file for geometry_streaming_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef GEOMETRY_STREAMING_MANAGER_01_H
#define GEOMETRY_STREAMING_MANAGER_01_H
...
typedef struct geometry_streaming_manager_01 geometry_streaming_manager_01_t;
typedef struct geometry_streaming_manager_01_desc geometry_streaming_manager_01_desc_t;
typedef struct geometry_streaming_manager_01_stats geometry_streaming_manager_01_stats_t;

/* Creation and destruction */
int geometry_streaming_manager_01_create(geometry_streaming_manager_01_t** out_ctx, const geometry_streaming_manager_01_desc_t* desc);
int geometry_streaming_manager_01_destroy(geometry_streaming_manager_01_t* ctx);
...
#endif /* GEOMETRY_STREAMING_MANAGER_01_H */
