/*
 * geometry_mesh_renderer_03.h
 *
 * Header file for geometry_mesh_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef GEOMETRY_MESH_RENDERER_03_H
#define GEOMETRY_MESH_RENDERER_03_H
...
typedef struct geometry_mesh_renderer_03 geometry_mesh_renderer_03_t;
typedef struct geometry_mesh_renderer_03_desc geometry_mesh_renderer_03_desc_t;
typedef struct geometry_mesh_renderer_03_stats geometry_mesh_renderer_03_stats_t;

/* Creation and destruction */
int geometry_mesh_renderer_03_create(geometry_mesh_renderer_03_t** out_ctx, const geometry_mesh_renderer_03_desc_t* desc);
int geometry_mesh_renderer_03_destroy(geometry_mesh_renderer_03_t* ctx);
...
#endif /* GEOMETRY_MESH_RENDERER_03_H */
