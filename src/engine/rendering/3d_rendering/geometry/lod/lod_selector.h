...
typedef struct geometry_lod_selector_handle {
    uint32_t id;
} geometry_lod_selector_handle_t;

typedef struct geometry_lod_selector_desc {
    uint32_t flags;
    void* user_data;
} geometry_lod_selector_desc_t;

typedef struct geometry_lod_selector_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} geometry_lod_selector_info_t;
