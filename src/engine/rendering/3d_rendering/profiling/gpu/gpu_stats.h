...
#ifndef PROFILING_GPU_STATS_H
#define PROFILING_GPU_STATS_H
...
typedef struct profiling_gpu_stats_handle {
    uint32_t id;
} profiling_gpu_stats_handle_t;

typedef struct profiling_gpu_stats_desc {
    uint32_t flags;
    void* user_data;
} profiling_gpu_stats_desc_t;

typedef struct profiling_gpu_stats_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} profiling_gpu_stats_info_t;
