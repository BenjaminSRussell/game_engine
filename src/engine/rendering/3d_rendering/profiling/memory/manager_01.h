/*
 * profiling_memory_manager_01.h
 *
 * Header file for profiling_memory_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef PROFILING_MEMORY_MANAGER_01_H
#define PROFILING_MEMORY_MANAGER_01_H
...
typedef struct profiling_memory_manager_01 profiling_memory_manager_01_t;
typedef struct profiling_memory_manager_01_desc profiling_memory_manager_01_desc_t;
typedef struct profiling_memory_manager_01_stats profiling_memory_manager_01_stats_t;

/* Creation and destruction */
int profiling_memory_manager_01_create(profiling_memory_manager_01_t** out_ctx, const profiling_memory_manager_01_desc_t* desc);
int profiling_memory_manager_01_destroy(profiling_memory_manager_01_t* ctx);
...
#endif /* PROFILING_MEMORY_MANAGER_01_H */
