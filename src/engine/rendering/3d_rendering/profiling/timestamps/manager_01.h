/*
 * profiling_timestamps_manager_01.h
 *
 * Header file for profiling_timestamps_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef PROFILING_TIMESTAMPS_MANAGER_01_H
#define PROFILING_TIMESTAMPS_MANAGER_01_H
...
typedef struct profiling_timestamps_manager_01 profiling_timestamps_manager_01_t;
typedef struct profiling_timestamps_manager_01_desc profiling_timestamps_manager_01_desc_t;
typedef struct profiling_timestamps_manager_01_stats profiling_timestamps_manager_01_stats_t;

/* Creation and destruction */
int profiling_timestamps_manager_01_create(profiling_timestamps_manager_01_t** out_ctx, const profiling_timestamps_manager_01_desc_t* desc);
int profiling_timestamps_manager_01_destroy(profiling_timestamps_manager_01_t* ctx);
...
#endif /* PROFILING_TIMESTAMPS_MANAGER_01_H */
