/*
 * profiling_export_processor_04.h
 *
 * Header file for profiling_export_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef PROFILING_EXPORT_PROCESSOR_04_H
#define PROFILING_EXPORT_PROCESSOR_04_H
...
typedef struct profiling_export_processor_04 profiling_export_processor_04_t;
typedef struct profiling_export_processor_04_desc profiling_export_processor_04_desc_t;
typedef struct profiling_export_processor_04_stats profiling_export_processor_04_stats_t;

/* Creation and destruction */
int profiling_export_processor_04_create(profiling_export_processor_04_t** out_ctx, const profiling_export_processor_04_desc_t* desc);
int profiling_export_processor_04_destroy(profiling_export_processor_04_t* ctx);
...
#endif /* PROFILING_EXPORT_PROCESSOR_04_H */
