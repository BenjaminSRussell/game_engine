/*
 * culling_frustum_processor_04.h
 *
 * Header file for culling_frustum_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef CULLING_FRUSTUM_PROCESSOR_04_H
#define CULLING_FRUSTUM_PROCESSOR_04_H
...
typedef struct culling_frustum_processor_04 culling_frustum_processor_04_t;
typedef struct culling_frustum_processor_04_desc culling_frustum_processor_04_desc_t;
typedef struct culling_frustum_processor_04_stats culling_frustum_processor_04_stats_t;

/* Creation and destruction */
int culling_frustum_processor_04_create(culling_frustum_processor_04_t** out_ctx, const culling_frustum_processor_04_desc_t* desc);
int culling_frustum_processor_04_destroy(culling_frustum_processor_04_t* ctx);
...
#endif /* CULLING_FRUSTUM_PROCESSOR_04_H */
