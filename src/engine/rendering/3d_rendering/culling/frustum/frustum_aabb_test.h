...
#ifndef CULLING_FRUSTUM_AABB_TEST_H
#define CULLING_FRUSTUM_AABB_TEST_H
...
typedef struct culling_frustum_aabb_test_handle {
    uint32_t id;
} culling_frustum_aabb_test_handle_t;

typedef struct culling_frustum_aabb_test_desc {
    uint32_t flags;
    void* user_data;
} culling_frustum_aabb_test_desc_t;

typedef struct culling_frustum_aabb_test_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} culling_frustum_aabb_test_info_t;
...
#endif /* CULLING_FRUSTUM_AABB_TEST_H */
