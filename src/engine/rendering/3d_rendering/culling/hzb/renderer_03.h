/*
 * culling_hzb_renderer_03.h
 *
 * Header file for culling_hzb_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef CULLING_HZB_RENDERER_03_H
#define CULLING_HZB_RENDERER_03_H
...
typedef struct culling_hzb_renderer_03 culling_hzb_renderer_03_t;
typedef struct culling_hzb_renderer_03_desc culling_hzb_renderer_03_desc_t;
typedef struct culling_hzb_renderer_03_stats culling_hzb_renderer_03_stats_t;

/* Creation and destruction */
int culling_hzb_renderer_03_create(culling_hzb_renderer_03_t** out_ctx, const culling_hzb_renderer_03_desc_t* desc);
int culling_hzb_renderer_03_destroy(culling_hzb_renderer_03_t* ctx);
...
#endif /* CULLING_HZB_RENDERER_03_H */
