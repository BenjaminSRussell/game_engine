/*
 * landscape_tessellation_processor_04.h
 *
 * Header file for landscape_tessellation_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LANDSCAPE_TESSELLATION_PROCESSOR_04_H
#define LANDSCAPE_TESSELLATION_PROCESSOR_04_H
...
typedef struct landscape_tessellation_processor_04 landscape_tessellation_processor_04_t;
typedef struct landscape_tessellation_processor_04_desc landscape_tessellation_processor_04_desc_t;
typedef struct landscape_tessellation_processor_04_stats landscape_tessellation_processor_04_stats_t;

/* Creation and destruction */
int landscape_tessellation_processor_04_create(landscape_tessellation_processor_04_t** out_ctx, const landscape_tessellation_processor_04_desc_t* desc);
int landscape_tessellation_processor_04_destroy(landscape_tessellation_processor_04_t* ctx);
...
#endif /* LANDSCAPE_TESSELLATION_PROCESSOR_04_H */
