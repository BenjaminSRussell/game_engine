/*
 * landscape_tessellation_manager_01.h
 *
 * Header file for landscape_tessellation_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef LANDSCAPE_TESSELLATION_MANAGER_01_H
#define LANDSCAPE_TESSELLATION_MANAGER_01_H
...
typedef struct landscape_tessellation_manager_01 landscape_tessellation_manager_01_t;
typedef struct landscape_tessellation_manager_01_desc landscape_tessellation_manager_01_desc_t;
typedef struct landscape_tessellation_manager_01_stats landscape_tessellation_manager_01_stats_t;

/* Creation and destruction */
int landscape_tessellation_manager_01_create(landscape_tessellation_manager_01_t** out_ctx, const landscape_tessellation_manager_01_desc_t* desc);
int landscape_tessellation_manager_01_destroy(landscape_tessellation_manager_01_t* ctx);
...
#endif /* LANDSCAPE_TESSELLATION_MANAGER_01_H */
