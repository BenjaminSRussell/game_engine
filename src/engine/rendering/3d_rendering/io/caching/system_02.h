/*
 * io_caching_system_02.h
 *
 * Header file for io_caching_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef IO_CACHING_SYSTEM_02_H
#define IO_CACHING_SYSTEM_02_H
...
typedef struct io_caching_system_02 io_caching_system_02_t;
typedef struct io_caching_system_02_desc io_caching_system_02_desc_t;
typedef struct io_caching_system_02_stats io_caching_system_02_stats_t;

/* Creation and destruction */
int io_caching_system_02_create(io_caching_system_02_t** out_ctx, const io_caching_system_02_desc_t* desc);
int io_caching_system_02_destroy(io_caching_system_02_t* ctx);
...
int io_caching_system_02_optimize(io_caching_system_02_t* ctx);
