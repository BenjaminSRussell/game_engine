...
#ifndef POSTPROCESSING_DOF_COC_H
#define POSTPROCESSING_DOF_COC_H
...
typedef struct postprocessing_dof_coc_handle {
    uint32_t id;
} postprocessing_dof_coc_handle_t;

typedef struct postprocessing_dof_coc_desc {
    uint32_t flags;
    void* user_data;
} postprocessing_dof_coc_desc_t;

typedef struct postprocessing_dof_coc_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} postprocessing_dof_coc_info_t;
...
#endif /* POSTPROCESSING_DOF_COC_H */
