 ...
 */
typedef struct { resource_handle_t id; } buffer_handle_t;
typedef struct { resource_handle_t id; } texture_handle_t;
typedef struct { resource_handle_t id; } sampler_handle_t;
typedef struct { resource_handle_t id; } shader_handle_t;
typedef struct { resource_handle_t id; } material_handle_t;
typedef struct { resource_handle_t id; } accel_struct_handle_t;
