...
typedef struct effects_particle_forces_handle {
    uint32_t id;
} effects_particle_forces_handle_t;

typedef struct effects_particle_forces_desc {
    uint32_t flags;
    void* user_data;
} effects_particle_forces_desc_t;

typedef struct effects_particle_forces_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} effects_particle_forces_info_t;
