/*
 * effects_environmental_builder_05.h
 *
 * Header file for effects_environmental_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EFFECTS_ENVIRONMENTAL_BUILDER_05_H
#define EFFECTS_ENVIRONMENTAL_BUILDER_05_H
...
typedef struct effects_environmental_builder_05 effects_environmental_builder_05_t;
typedef struct effects_environmental_builder_05_desc effects_environmental_builder_05_desc_t;
typedef struct effects_environmental_builder_05_stats effects_environmental_builder_05_stats_t;

/* Creation and destruction */
int effects_environmental_builder_05_create(effects_environmental_builder_05_t** out_ctx, const effects_environmental_builder_05_desc_t* desc);
int effects_environmental_builder_05_destroy(effects_environmental_builder_05_t* ctx);
...
#endif /* EFFECTS_ENVIRONMENTAL_BUILDER_05_H */
