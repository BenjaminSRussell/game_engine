/*
 * effects_particles_builder_05.h
 *
 * Header file for effects_particles_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EFFECTS_PARTICLES_BUILDER_05_H
#define EFFECTS_PARTICLES_BUILDER_05_H
...
typedef struct effects_particles_builder_05 effects_particles_builder_05_t;
typedef struct effects_particles_builder_05_desc effects_particles_builder_05_desc_t;
typedef struct effects_particles_builder_05_stats effects_particles_builder_05_stats_t;

/* Creation and destruction */
int effects_particles_builder_05_create(effects_particles_builder_05_t** out_ctx, const effects_particles_builder_05_desc_t* desc);
int effects_particles_builder_05_destroy(effects_particles_builder_05_t* ctx);
...
#endif /* EFFECTS_PARTICLES_BUILDER_05_H */
