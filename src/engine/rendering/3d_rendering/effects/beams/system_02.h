/*
 * effects_beams_system_02.h
 *
 * Header file for effects_beams_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EFFECTS_BEAMS_SYSTEM_02_H
#define EFFECTS_BEAMS_SYSTEM_02_H
...
typedef struct effects_beams_system_02 effects_beams_system_02_t;
typedef struct effects_beams_system_02_desc effects_beams_system_02_desc_t;
typedef struct effects_beams_system_02_stats effects_beams_system_02_stats_t;

/* Creation and destruction */
int effects_beams_system_02_create(effects_beams_system_02_t** out_ctx, const effects_beams_system_02_desc_t* desc);
int effects_beams_system_02_destroy(effects_beams_system_02_t* ctx);
...
#endif /* EFFECTS_BEAMS_SYSTEM_02_H */
