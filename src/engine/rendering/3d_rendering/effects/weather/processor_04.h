/*
 * effects_weather_processor_04.h
 *
 * Header file for effects_weather_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EFFECTS_WEATHER_PROCESSOR_04_H
#define EFFECTS_WEATHER_PROCESSOR_04_H
...
typedef struct effects_weather_processor_04 effects_weather_processor_04_t;
typedef struct effects_weather_processor_04_desc effects_weather_processor_04_desc_t;
typedef struct effects_weather_processor_04_stats effects_weather_processor_04_stats_t;

/* Creation and destruction */
int effects_weather_processor_04_create(effects_weather_processor_04_t** out_ctx, const effects_weather_processor_04_desc_t* desc);
int effects_weather_processor_04_destroy(effects_weather_processor_04_t* ctx);
...
#endif /* EFFECTS_WEATHER_PROCESSOR_04_H */
