/*
 * effects_caustics_builder_05.h
 *
 * Header file for effects_caustics_builder_05 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef EFFECTS_CAUSTICS_BUILDER_05_H
#define EFFECTS_CAUSTICS_BUILDER_05_H
...
typedef struct effects_caustics_builder_05 effects_caustics_builder_05_t;
typedef struct effects_caustics_builder_05_desc effects_caustics_builder_05_desc_t;
typedef struct effects_caustics_builder_05_stats effects_caustics_builder_05_stats_t;

/* Creation and destruction */
int effects_caustics_builder_05_create(effects_caustics_builder_05_t** out_ctx, const effects_caustics_builder_05_desc_t* desc);
int effects_caustics_builder_05_destroy(effects_caustics_builder_05_t* ctx);
...
#endif /* EFFECTS_CAUSTICS_BUILDER_05_H */
