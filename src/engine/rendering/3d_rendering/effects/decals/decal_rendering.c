...
#define EFFECTS_DECAL_RENDERING_ALIGNMENT 16
...
static bool effects_decal_rendering_validate(const effects_decal_rendering_internal_t* item) {
    // TODO: Implement GPU particle system
    // TODO: Add particle collision
...
int effects_decal_rendering_init(void) {
    ...
    if (g_decal_rendering_ctx.initialized) {
    ...
    if (!g_decal_rendering_ctx.items) {
        return -1;
    }
...
void effects_decal_rendering_shutdown(void) {
    ...
    for (uint32_t i = 0; i < g_decal_rendering_ctx.count; i++) {
        effects_decal_rendering_cleanup_internal(&g_decal_rendering_ctx.items[i]);
    }

    free(g_decal_rendering_ctx.items);
    g_decal_rendering_ctx.items = NULL;
    g_decal_rendering_ctx.count = 0;
    g_decal_rendering_ctx.capacity = 0;
...
void effects_decal_rendering_destroy(effects_decal_rendering_handle_t handle) {
    ...
    effects_decal_rendering_cleanup_internal(&g_decal_rendering_ctx.items[handle.id]);
}
...
int effects_decal_rendering_update(effects_decal_rendering_handle_t handle, const void* data, size_t size) {
    ...
    effects_decal_rendering_internal_t* item = &g_decal_rendering_ctx.items[handle.id];
    if (!item->initialized) {
        return -2;
    }
...
bool effects_decal_rendering_is_valid(effects_decal_rendering_handle_t handle) {
    ...
    return g_decal_rendering_ctx.items[handle.id].initialized;
}
...
int effects_decal_rendering_get_info(effects_decal_rendering_handle_t handle, effects_decal_rendering_info_t* out_info) {
    ...
    const effects_decal_rendering_internal_t* item = &g_decal_rendering_ctx.items[handle.id];
    out_info->id = item->id;
...
void effects_decal_rendering_mark_dirty(effects_decal_rendering_handle_t handle) {
    // TODO: Implement decal rendering culling integration
    if (handle.id < g_decal_rendering_ctx.count) {
        g_decal_rendering_ctx.items[handle.id].dirty = true;
    }
}
...
int effects_decal_rendering_process_pending(void) {
    ...
    int processed = 0;
    for (uint32_t i = 0; i < g_decal_rendering_ctx.count; i++) {
        effects_decal_rendering_internal_t* item = &g_decal_rendering_ctx.items[i];
...
uint32_t effects_decal_rendering_get_count(void) {
    return g_decal_rendering_ctx.count;
}
