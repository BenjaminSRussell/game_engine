/*
 * debugging_logging_processor_04.h
 *
 * Header file for debugging_logging_processor_04 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef DEBUGGING_LOGGING_PROCESSOR_04_H
#define DEBUGGING_LOGGING_PROCESSOR_04_H
...
typedef struct debugging_logging_processor_04 debugging_logging_processor_04_t;
typedef struct debugging_logging_processor_04_desc debugging_logging_processor_04_desc_t;
typedef struct debugging_logging_processor_04_stats debugging_logging_processor_04_stats_t;

/* Creation and destruction */
int debugging_logging_processor_04_create(debugging_logging_processor_04_t** out_ctx, const debugging_logging_processor_04_desc_t* desc);
int debugging_logging_processor_04_destroy(debugging_logging_processor_04_t* ctx);
...
#endif /* DEBUGGING_LOGGING_PROCESSOR_04_H */
