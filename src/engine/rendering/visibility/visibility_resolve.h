...
#ifndef RENDERING_VISIBILITY_RESOLVE_H
#define RENDERING_VISIBILITY_RESOLVE_H
...
typedef struct rendering_visibility_resolve_handle {
    uint32_t id;
} rendering_visibility_resolve_handle_t;

typedef struct rendering_visibility_resolve_desc {
    uint32_t flags;
    void* user_data;
} rendering_visibility_resolve_desc_t;

typedef struct rendering_visibility_resolve_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} rendering_visibility_resolve_info_t;
...
#endif /* RENDERING_VISIBILITY_RESOLVE_H */
