...
#ifndef GEOMETRY_INDEX_BUFFER_POOL_H
#define GEOMETRY_INDEX_BUFFER_POOL_H
...
typedef struct geometry_index_buffer_pool_handle {
    uint32_t id;
} geometry_index_buffer_pool_handle_t;

typedef struct geometry_index_buffer_pool_desc {
    uint32_t flags;
    void* user_data;
} geometry_index_buffer_pool_desc_t;

typedef struct geometry_index_buffer_pool_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} geometry_index_buffer_pool_info_t;
...
#endif /* GEOMETRY_INDEX_BUFFER_POOL_H */
