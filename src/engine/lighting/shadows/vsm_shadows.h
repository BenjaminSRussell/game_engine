...
#ifndef LIGHTING_VSM_SHADOWS_H
#define LIGHTING_VSM_SHADOWS_H
...
typedef struct lighting_vsm_shadows_handle {
    uint32_t id;
} lighting_vsm_shadows_handle_t;

typedef struct lighting_vsm_shadows_desc {
    uint32_t flags;
    void* user_data;
} lighting_vsm_shadows_desc_t;

typedef struct lighting_vsm_shadows_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} lighting_vsm_shadows_info_t;
