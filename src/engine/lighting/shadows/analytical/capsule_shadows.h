...
#ifndef SHADOWS_ADVANCED_CAPSULE_SHADOWS_H
#define SHADOWS_ADVANCED_CAPSULE_SHADOWS_H
...
typedef struct shadows_advanced_capsule_shadows_handle {
    uint32_t id;
} shadows_advanced_capsule_shadows_handle_t;

typedef struct shadows_advanced_capsule_shadows_desc {
    uint32_t flags;
    void* user_data;
} shadows_advanced_capsule_shadows_desc_t;

typedef struct shadows_advanced_capsule_shadows_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shadows_advanced_capsule_shadows_info_t;
...
#endif /* SHADOWS_ADVANCED_CAPSULE_SHADOWS_H */
