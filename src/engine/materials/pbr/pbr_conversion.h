...
#ifndef MATERIALS_PBR_CONVERSION_H
#define MATERIALS_PBR_CONVERSION_H
...
typedef struct materials_pbr_conversion_handle {
    uint32_t id;
} materials_pbr_conversion_handle_t;

typedef struct materials_pbr_conversion_desc {
    uint32_t flags;
    void* user_data;
} materials_pbr_conversion_desc_t;

typedef struct materials_pbr_conversion_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_pbr_conversion_info_t;
...
#endif /* MATERIALS_PBR_CONVERSION_H */
