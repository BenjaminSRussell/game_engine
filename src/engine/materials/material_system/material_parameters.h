...
#ifndef MATERIALS_MATERIAL_PARAMETERS_H
#define MATERIALS_MATERIAL_PARAMETERS_H
...
typedef struct materials_material_parameters_handle {
    uint32_t id;
} materials_material_parameters_handle_t;

typedef struct materials_material_parameters_desc {
    uint32_t flags;
    void* user_data;
} materials_material_parameters_desc_t;

typedef struct materials_material_parameters_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_material_parameters_info_t;
...
#endif /* MATERIALS_MATERIAL_PARAMETERS_H */
