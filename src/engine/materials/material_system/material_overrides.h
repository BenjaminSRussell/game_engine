...
#ifndef MATERIALS_MATERIAL_OVERRIDES_H
#define MATERIALS_MATERIAL_OVERRIDES_H
...
typedef struct materials_material_overrides_handle {
    uint32_t id;
} materials_material_overrides_handle_t;

typedef struct materials_material_overrides_desc {
    uint32_t flags;
    void* user_data;
} materials_material_overrides_desc_t;

typedef struct materials_material_overrides_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_material_overrides_info_t;
...
#endif /* MATERIALS_MATERIAL_OVERRIDES_H */
