...
typedef enum {
  PLATFORM_OCCLUSION_NONE = 0,
  PLATFORM_OCCLUSION_PORTAL = 1,
  PLATFORM_OCCLUSION_HARDWARE = 2
} PlatformOcclusionMode;
...
/// Set occlusion mode
void occlusion_set_mode(PlatformOcclusionMode mode);

/// Get occlusion mode
PlatformOcclusionMode occlusion_get_mode(void);
