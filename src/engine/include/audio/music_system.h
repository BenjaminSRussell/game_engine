...
// Playlist management
void music_create_playlist(MusicSystem *music, MusicMood mood, MusicContext context);
...
void music_set_context_volume(MusicSystem *music, MusicContext context, f32 volume);
...
u32 music_find_suitable_track(MusicSystem *music, MusicMood mood, MusicContext context);
...
bool music_is_track_suitable(MusicTrack *track, MusicMood mood, MusicContext context);
