...
typedef struct World {
  ...
  typedef struct ECSChunk ECSChunk;
...
#define ARCHETYPE_CHUNK_SIZE 16384 // 16KB chunks for optimal cache usage
  ...
  ECSComponentID ecs_register_component(World *world,
  ...
  bool ecs_add_component(World *world, Entity entity,
  ...
  bool ecs_set_component(World *world, Entity entity,
                         ECSComponentID component_id, const void *data);
...
#define ECS_SYSTEM_CREATE(world, name, func, query)                            \
  ...
  void ecs_animation_components_simd(void *components, u32 count,
                                     f32 delta_time);
