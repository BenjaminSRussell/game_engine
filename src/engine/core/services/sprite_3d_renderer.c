...
static bool sprite_3d_renderer_init(IRenderer *self,
...
static void sprite_3d_renderer_update_camera(IRenderer *self,
                                             struct Camera *camera, f32 aspect);
static void sprite_3d_renderer_update_camera_uniforms(IRenderer *self,
                                                      struct Camera *camera,
                                                      f32 aspect);
static void sprite_3d_renderer_render_chunk(IRenderer *self, Chunk *chunk,
                                            Mat4 view, Mat4 proj);
static void sprite_3d_renderer_render_chunk_mesh(IRenderer *self, Chunk *chunk,
                                                 Mat4 view, Mat4 proj);
static void sprite_3d_renderer_render_dynamic_mesh(IRenderer *self, Mesh *mesh,
                                                   Mat4 view, Mat4 proj);
static void sprite_3d_renderer_render_sprite(IRenderer *self, Vec3 position,
                                             Vec2 size, u32 texture_id,
                                             f32 rotation);
static void sprite_3d_renderer_render_entity_sprite(IRenderer *self,
                                                    Entity entity,
                                                    Vec3 position, Vec2 size,
                                                    u32 texture_id);
static void sprite_3d_renderer_render_ui_quad(IRenderer *self, Vec2 pos,
                                              Vec2 size, u32 texture_id);
static void sprite_3d_renderer_render_text(IRenderer *self, const char *text,
                                           Vec2 pos, f32 scale, Vec3 color);
static void
sprite_3d_renderer_render_block_highlight(IRenderer *self,
                                          struct PlayerSystem *player_system);
static void sprite_3d_renderer_render_physics_debug(IRenderer *self, Mat4 view,
                                                    Mat4 proj);
static void sprite_3d_renderer_set_ambient_light(IRenderer *self,
                                                 f32 ambient_light);
static bool sprite_3d_renderer_create_chunk_buffers(IRenderer *self, Mesh *mesh,
                                                    void **vertex_buffer,
                                                    void **index_buffer);
static bool sprite_3d_renderer_update_chunk_buffers(IRenderer *self, Mesh *mesh,
                                                    void *vertex_buffer,
                                                    void *index_buffer);
...
IRenderer *sprite_3d_renderer_create(void) {
  ...
  Sprite3DRendererData *data =
      (Sprite3DRendererData *)calloc(1, sizeof(Sprite3DRendererData));
  if (!data) {
    free(renderer);
    return NULL;
  }
...
static bool sprite_3d_renderer_init(IRenderer *self,
  ...
  // SPRITE-3D-SYSTEM-001: Initialize sprite rendering backend (OpenGL, Metal,
  // etc.) Implementation would initialize the appropriate graphics backend
...
static void sprite_3d_renderer_cleanup(IRenderer *self) {
  ...
  // SPRITE-3D-SYSTEM-002: Cleanup sprite rendering resources
...
static void sprite_3d_renderer_resize(IRenderer *self, u32 width, u32 height) {
  ...
  (void)width;
  (void)height;
  // SPRITE-3D-SYSTEM-003: Handle resize
...
static void sprite_3d_renderer_end_frame(IRenderer *self, u32 image_index) {
  (void)self;
  (void)image_index;
  // SPRITE-3D-SYSTEM-004: Present frame
...
static void sprite_3d_renderer_update_camera(IRenderer *self,
  ...
  (void)camera;
  (void)aspect;
  // SPRITE-3D-SYSTEM-005: Update camera for sprite rendering
...
static void sprite_3d_renderer_update_camera_uniforms(IRenderer *self,
  ...
  (void)camera;
  (void)aspect;
  // SPRITE-3D-SYSTEM-006: Update camera uniforms
...
static void sprite_3d_renderer_render_chunk(IRenderer *self, Chunk *chunk,
  ...
  (void)view;
  (void)proj;
  // SPRITE-3D-SYSTEM-007: Render chunk as heightmap with sprites
...
static void sprite_3d_renderer_render_chunk_mesh(IRenderer *self, Chunk *chunk,
  ...
  (void)view;
  (void)proj;
  // SPRITE-3D-SYSTEM-008: Render chunk mesh as sprites
...
static void sprite_3d_renderer_render_dynamic_mesh(IRenderer *self, Mesh *mesh,
  ...
  (void)view;
  (void)proj;
  // SPRITE-3D-SYSTEM-009: Render dynamic mesh as sprites
...
static void sprite_3d_renderer_render_sprite(IRenderer *self, Vec3 position,
  ...
  (void)texture_id;
  (void)rotation;
  // SPRITE-3D-SYSTEM-010: Render sprite at position
...
static void sprite_3d_renderer_render_entity_sprite(IRenderer *self,
  ...
  (void)size;
  (void)texture_id;
  // SPRITE-3D-SYSTEM-011: Render entity sprite
...
static void sprite_3d_renderer_render_ui_quad(IRenderer *self, Vec2 pos,
  ...
  (void)size;
  (void)texture_id;
  // SPRITE-3D-SYSTEM-012: Render UI quad
...
static void sprite_3d_renderer_render_text(IRenderer *self, const char *text,
  ...
  (void)scale;
  (void)color;
  // SPRITE-3D-SYSTEM-013: Render text
...
sprite_3d_renderer_render_block_highlight(IRenderer *self,
  ...
  (void)self;
  (void)player_system;
  // SPRITE-3D-SYSTEM-014: Render block highlight
...
static void sprite_3d_renderer_render_physics_debug(IRenderer *self, Mat4 view,
  ...
  (void)view;
  (void)proj;
  // SPRITE-3D-SYSTEM-015: Render physics debug
...
static void sprite_3d_renderer_set_ambient_light(IRenderer *self,
  ...
  (void)self;
  (void)ambient_light;
  // SPRITE-3D-SYSTEM-016: Set ambient light
...
static bool sprite_3d_renderer_create_chunk_buffers(IRenderer *self, Mesh *mesh,
  ...
  (void)vertex_buffer;
  (void)index_buffer;
  // SPRITE-3D-SYSTEM-017: Create sprite buffers
...
static bool sprite_3d_renderer_update_chunk_buffers(IRenderer *self, Mesh *mesh,
  ...
  (void)vertex_buffer;
  (void)index_buffer;
  // SPRITE-3D-SYSTEM-018: Update sprite buffers
