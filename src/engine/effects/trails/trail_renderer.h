...
#ifndef EFFECTS_TRAIL_RENDERER_H
#define EFFECTS_TRAIL_RENDERER_H
...
typedef struct effects_trail_renderer_handle {
    uint32_t id;
} effects_trail_renderer_handle_t;

typedef struct effects_trail_renderer_desc {
    uint32_t flags;
    void* user_data;
} effects_trail_renderer_desc_t;

typedef struct effects_trail_renderer_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} effects_trail_renderer_info_t;
...
#endif /* EFFECTS_TRAIL_RENDERER_H */
