...
#ifndef EFFECTS_TRAIL_WIDTH_H
#define EFFECTS_TRAIL_WIDTH_H
...
typedef struct effects_trail_width_handle {
    uint32_t id;
} effects_trail_width_handle_t;

typedef struct effects_trail_width_desc {
    uint32_t flags;
    void* user_data;
} effects_trail_width_desc_t;

typedef struct effects_trail_width_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} effects_trail_width_info_t;
