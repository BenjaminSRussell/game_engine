...
#ifndef PLATFORM_DX_COMMAND_LIST_H
#define PLATFORM_DX_COMMAND_LIST_H
...
typedef struct platform_dx_command_list_handle {
    uint32_t id;
} platform_dx_command_list_handle_t;

typedef struct platform_dx_command_list_desc {
    uint32_t flags;
    void* user_data;
} platform_dx_command_list_desc_t;

typedef struct platform_dx_command_list_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} platform_dx_command_list_info_t;
...
#endif /* PLATFORM_DX_COMMAND_LIST_H */
