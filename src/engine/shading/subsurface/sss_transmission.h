...
#ifndef SHADING_SSS_TRANSMISSION_H
#define SHADING_SSS_TRANSMISSION_H
...
typedef struct shading_sss_transmission_handle {
    uint32_t id;
} shading_sss_transmission_handle_t;

typedef struct shading_sss_transmission_desc {
    uint32_t flags;
    void* user_data;
} shading_sss_transmission_desc_t;

typedef struct shading_sss_transmission_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shading_sss_transmission_info_t;
...
#endif /* SHADING_SSS_TRANSMISSION_H */
