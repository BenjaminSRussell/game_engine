...
#ifndef EDITOR_EDITOR_SELECTION_H
#define EDITOR_EDITOR_SELECTION_H
...
typedef struct editor_editor_selection_handle {
    uint32_t id;
} editor_editor_selection_handle_t;

typedef struct editor_editor_selection_desc {
    uint32_t flags;
    void* user_data;
} editor_editor_selection_desc_t;

typedef struct editor_editor_selection_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} editor_editor_selection_info_t;
...
#endif /* EDITOR_EDITOR_SELECTION_H */
