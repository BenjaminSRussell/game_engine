...
#ifndef EDITOR_DEBUG_SHAPES_H
#define EDITOR_DEBUG_SHAPES_H
...
typedef struct editor_debug_shapes_handle {
    uint32_t id;
} editor_debug_shapes_handle_t;

typedef struct editor_debug_shapes_desc {
    uint32_t flags;
    void* user_data;
} editor_debug_shapes_desc_t;

typedef struct editor_debug_shapes_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} editor_debug_shapes_info_t;
