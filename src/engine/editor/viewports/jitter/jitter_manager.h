/*
 * viewports_jitter_manager_01.h
 *
 * Header file for viewports_jitter_manager_01 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef VIEWPORTS_JITTER_MANAGER_01_H
#define VIEWPORTS_JITTER_MANAGER_01_H
...
typedef struct viewports_jitter_manager_01 viewports_jitter_manager_01_t;
typedef struct viewports_jitter_manager_01_desc viewports_jitter_manager_01_desc_t;
typedef struct viewports_jitter_manager_01_stats viewports_jitter_manager_01_stats_t;

/* Creation and destruction */
int viewports_jitter_manager_01_create(viewports_jitter_manager_01_t** out_ctx, const viewports_jitter_manager_01_desc_t* desc);
int viewports_jitter_manager_01_destroy(viewports_jitter_manager_01_t* ctx);
...
int viewports_jitter_manager_01_create_legacy(viewports_jitter_manager_01_t* ctx, void* params);
int viewports_jitter_manager_01_destroy_legacy(viewports_jitter_manager_01_t* ctx, void* params);
...
#endif /* VIEWPORTS_JITTER_MANAGER_01_H */
