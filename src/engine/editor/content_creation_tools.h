...
void content_creation_save_as_template(BlockDefinition* block, const char* template_name);
void content_creation_save_as_template(ItemDefinition* item, const char* template_name);
void content_creation_save_as_template(MobDefinition* mob, const char* template_name);
