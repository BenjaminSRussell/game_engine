...
#ifndef EDITOR_PLACEMENT_PREVIEW_H
#define EDITOR_PLACEMENT_PREVIEW_H
...
typedef struct editor_placement_preview_handle {
    uint32_t id;
} editor_placement_preview_handle_t;

typedef struct editor_placement_preview_desc {
    uint32_t flags;
    void* user_data;
} editor_placement_preview_desc_t;

typedef struct editor_placement_preview_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} editor_placement_preview_info_t;
...
#endif /* EDITOR_PLACEMENT_PREVIEW_H */
