...
#ifndef PROFILING_THREAD_PROFILER_H
#define PROFILING_THREAD_PROFILER_H
...
typedef struct profiling_thread_profiler_handle {
    uint32_t id;
} profiling_thread_profiler_handle_t;

typedef struct profiling_thread_profiler_desc {
    uint32_t flags;
    void* user_data;
} profiling_thread_profiler_desc_t;

typedef struct profiling_thread_profiler_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} profiling_thread_profiler_info_t;
...
#endif /* PROFILING_THREAD_PROFILER_H */
