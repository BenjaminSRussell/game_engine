...
#include "editor/debugging/replay/replay_manager.h"
 ...
 * Complexity: O(n) where n is the number of elements
 */
int debugging_replay_manager_01_create_legacy(debugging_replay_manager_01_t* ctx, void* params) {
    if (!ctx) {
 ...
 * Complexity: O(n) where n is the number of elements
 */
int debugging_replay_manager_01_destroy_legacy(debugging_replay_manager_01_t* ctx, void* params) {
    if (!ctx) {
