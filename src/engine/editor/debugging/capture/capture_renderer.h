/*
 * debugging_capture_renderer_03.h
 *
 * Header file for debugging_capture_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef DEBUGGING_CAPTURE_RENDERER_03_H
#define DEBUGGING_CAPTURE_RENDERER_03_H
...
typedef struct debugging_capture_renderer_03 debugging_capture_renderer_03_t;
typedef struct debugging_capture_renderer_03_desc debugging_capture_renderer_03_desc_t;
typedef struct debugging_capture_renderer_03_stats debugging_capture_renderer_03_stats_t;

/* Creation and destruction */
int debugging_capture_renderer_03_create(debugging_capture_renderer_03_t** out_ctx, const debugging_capture_renderer_03_desc_t* desc);
int debugging_capture_renderer_03_destroy(debugging_capture_renderer_03_t* ctx);
...
#endif /* DEBUGGING_CAPTURE_RENDERER_03_H */
