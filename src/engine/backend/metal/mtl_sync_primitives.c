...
#if defined(__OBJC__)
    if (encoder && event) {
        [(id)TO_RENDER_ENC(encoder) encodeSignalEvent:TO_EVENT(event) value:value];
    }
#endif
}
...
#if defined(__OBJC__)
    if (encoder && event) {
        [(id)TO_RENDER_ENC(encoder) encodeWaitForEvent:TO_EVENT(event) value:value];
    }
#endif
}
...
#if defined(__OBJC__)
    if (encoder && event) {
        [(id)TO_COMPUTE_ENC(encoder) encodeSignalEvent:TO_EVENT(event) value:value];
    }
#endif
}
...
#if defined(__OBJC__)
    if (encoder && event) {
        [(id)TO_COMPUTE_ENC(encoder) encodeWaitForEvent:TO_EVENT(event) value:value];
    }
#endif
}
...
#if defined(__OBJC__)
    if (encoder && event) {
        [(id)TO_BLIT_ENC(encoder) encodeSignalEvent:TO_EVENT(event) value:value];
    }
#endif
}
...
#if defined(__OBJC__)
    if (encoder && event) {
        [(id)TO_BLIT_ENC(encoder) encodeWaitForEvent:TO_EVENT(event) value:value];
    }
#endif
}
...
#if defined(__OBJC__)
    if (event) {
        // MTLEvent does not support signaledValue (only MTLSharedEvent does)
