...
void proc_turn_in_place_init() {
    g_turn.turn_speed = 180.0f; // degrees/sec
}

void proc_turn_in_place_update(float dt, float character_yaw, float desired_yaw, float velocity) {
...
int proc_turn_is_turning() {
    return g_turn.is_turning;
}
