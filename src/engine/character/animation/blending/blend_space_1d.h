...
typedef struct animation_blend_space_1d_handle {
    uint32_t id;
} animation_blend_space_1d_handle_t;

typedef struct animation_blend_space_1d_desc {
    uint32_t flags;
    void* user_data;
} animation_blend_space_1d_desc_t;

typedef struct animation_blend_space_1d_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} animation_blend_space_1d_info_t;
