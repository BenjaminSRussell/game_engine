...
#ifndef ANIMATION_GPU_MORPHING_H
#define ANIMATION_GPU_MORPHING_H
...
typedef struct animation_gpu_morphing_handle {
    uint32_t id;
} animation_gpu_morphing_handle_t;

typedef struct animation_gpu_morphing_desc {
    uint32_t flags;
    void* user_data;
} animation_gpu_morphing_desc_t;

typedef struct animation_gpu_morphing_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} animation_gpu_morphing_info_t;
...
#endif /* ANIMATION_GPU_MORPHING_H */
