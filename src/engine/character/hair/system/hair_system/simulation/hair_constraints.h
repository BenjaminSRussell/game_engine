...
#ifndef HAIR_SYSTEM_HAIR_CONSTRAINTS_H
#define HAIR_SYSTEM_HAIR_CONSTRAINTS_H
...
typedef struct hair_system_hair_constraints_handle {
    uint32_t id;
} hair_system_hair_constraints_handle_t;

typedef struct hair_system_hair_constraints_desc {
    uint32_t flags;
    void* user_data;
} hair_system_hair_constraints_desc_t;

typedef struct hair_system_hair_constraints_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} hair_system_hair_constraints_info_t;
...
#endif /* HAIR_SYSTEM_HAIR_CONSTRAINTS_H */
