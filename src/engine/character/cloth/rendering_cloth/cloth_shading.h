...
#ifndef CLOTH_SYSTEM_CLOTH_SHADING_H
#define CLOTH_SYSTEM_CLOTH_SHADING_H
...
typedef struct cloth_system_cloth_shading_handle {
    uint32_t id;
} cloth_system_cloth_shading_handle_t;

typedef struct cloth_system_cloth_shading_desc {
    uint32_t flags;
    void* user_data;
} cloth_system_cloth_shading_desc_t;

typedef struct cloth_system_cloth_shading_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} cloth_system_cloth_shading_info_t;
...
#endif /* CLOTH_SYSTEM_CLOTH_SHADING_H */
