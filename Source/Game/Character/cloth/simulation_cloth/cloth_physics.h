...
#ifndef CLOTH_SYSTEM_CLOTH_PHYSICS_H
#define CLOTH_SYSTEM_CLOTH_PHYSICS_H
...
typedef struct cloth_system_cloth_physics_handle {
    uint32_t id;
} cloth_system_cloth_physics_handle_t;

typedef struct cloth_system_cloth_physics_desc {
    uint32_t flags;
    void* user_data;
} cloth_system_cloth_physics_desc_t;

typedef struct cloth_system_cloth_physics_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} cloth_system_cloth_physics_info_t;
...
#endif /* CLOTH_SYSTEM_CLOTH_PHYSICS_H */
