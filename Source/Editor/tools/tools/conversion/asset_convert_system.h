/*
 * tools_conversion_system_02.h
 *
 * Header file for tools_conversion_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef TOOLS_CONVERSION_SYSTEM_02_H
#define TOOLS_CONVERSION_SYSTEM_02_H
...
typedef struct tools_conversion_system_02 tools_conversion_system_02_t;
typedef struct tools_conversion_system_02_desc tools_conversion_system_02_desc_t;
typedef struct tools_conversion_system_02_stats tools_conversion_system_02_stats_t;

/* Creation and destruction */
int tools_conversion_system_02_create(tools_conversion_system_02_t** out_ctx, const tools_conversion_system_02_desc_t* desc);
int tools_conversion_system_02_destroy(tools_conversion_system_02_t* ctx);
...
int tools_conversion_system_02_optimize_legacy(tools_conversion_system_02_t* ctx);
...
#endif /* TOOLS_CONVERSION_SYSTEM_02_H */
