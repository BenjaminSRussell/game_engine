/*
 * viewports_frustum_system_02.h
 *
 * Header file for viewports_frustum_system_02 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef VIEWPORTS_FRUSTUM_SYSTEM_02_H
#define VIEWPORTS_FRUSTUM_SYSTEM_02_H
...
typedef struct viewports_frustum_system_02 viewports_frustum_system_02_t;
typedef struct viewports_frustum_system_02_desc viewports_frustum_system_02_desc_t;
typedef struct viewports_frustum_system_02_stats viewports_frustum_system_02_stats_t;

/* Creation and destruction */
int viewports_frustum_system_02_create(viewports_frustum_system_02_t** out_ctx, const viewports_frustum_system_02_desc_t* desc);
int viewports_frustum_system_02_destroy(viewports_frustum_system_02_t* ctx);
...
int viewports_frustum_system_02_optimize_legacy(viewports_frustum_system_02_t* ctx);
...
#endif /* VIEWPORTS_FRUSTUM_SYSTEM_02_H */
