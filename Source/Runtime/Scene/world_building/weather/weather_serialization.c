...
// JSON Helper Forward Declarations
...
static bool extract_json_object(const char *json, char *buffer,
                                size_t buffer_size);
static bool extract_json_array_element(const char *json, size_t index,
                                       char *buffer, size_t buffer_size);

// Binary Helper Forward Declarations
