...
#ifndef VRS_VRS_INTEGRATION_H
#define VRS_VRS_INTEGRATION_H
...
typedef struct vrs_vrs_integration_handle {
    uint32_t id;
} vrs_vrs_integration_handle_t;

typedef struct vrs_vrs_integration_desc {
    uint32_t flags;
    void* user_data;
} vrs_vrs_integration_desc_t;

typedef struct vrs_vrs_integration_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} vrs_vrs_integration_info_t;
