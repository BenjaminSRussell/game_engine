...
#ifndef CULLING_GRID_CULLING_H
#define CULLING_GRID_CULLING_H
...
typedef struct culling_grid_culling_handle {
    uint32_t id;
} culling_grid_culling_handle_t;

typedef struct culling_grid_culling_desc {
    uint32_t flags;
    void* user_data;
} culling_grid_culling_desc_t;

typedef struct culling_grid_culling_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} culling_grid_culling_info_t;
