...
#ifndef SHADING_HAIR_SCATTERING_H
#define SHADING_HAIR_SCATTERING_H
...
typedef struct shading_hair_scattering_handle {
    uint32_t id;
} shading_hair_scattering_handle_t;

typedef struct shading_hair_scattering_desc {
    uint32_t flags;
    void* user_data;
} shading_hair_scattering_desc_t;

typedef struct shading_hair_scattering_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} shading_hair_scattering_info_t;
...
#endif /* SHADING_HAIR_SCATTERING_H */
