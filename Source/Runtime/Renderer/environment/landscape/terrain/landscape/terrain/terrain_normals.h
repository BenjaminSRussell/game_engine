...
#ifndef LANDSCAPE_TERRAIN_NORMALS_H
#define LANDSCAPE_TERRAIN_NORMALS_H
...
typedef struct landscape_terrain_normals_handle {
    uint32_t id;
} landscape_terrain_normals_handle_t;

typedef struct landscape_terrain_normals_desc {
    uint32_t flags;
    void* user_data;
} landscape_terrain_normals_desc_t;

typedef struct landscape_terrain_normals_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} landscape_terrain_normals_info_t;
...
#endif /* LANDSCAPE_TERRAIN_NORMALS_H */
