...
#ifndef DESTRUCTION_FRACTURE_PATTERN_H
#define DESTRUCTION_FRACTURE_PATTERN_H
...
typedef struct destruction_fracture_pattern_handle {
    uint32_t id;
} destruction_fracture_pattern_handle_t;

typedef struct destruction_fracture_pattern_desc {
    uint32_t flags;
    void* user_data;
} destruction_fracture_pattern_desc_t;

typedef struct destruction_fracture_pattern_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} destruction_fracture_pattern_info_t;
...
#endif /* DESTRUCTION_FRACTURE_PATTERN_H */
