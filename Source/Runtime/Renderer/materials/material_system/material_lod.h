...
#ifndef MATERIALS_MATERIAL_LOD_H
#define MATERIALS_MATERIAL_LOD_H
...
typedef struct materials_material_lod_handle {
    uint32_t id;
} materials_material_lod_handle_t;

typedef struct materials_material_lod_desc {
    uint32_t flags;
    void* user_data;
} materials_material_lod_desc_t;

typedef struct materials_material_lod_info {
    uint32_t id;
    uint32_t flags;
    bool initialized;
} materials_material_lod_info_t;
...
#endif /* MATERIALS_MATERIAL_LOD_H */
