/*
 * physics_soft_renderer_03.h
 *
 * Header file for physics_soft_renderer_03 implementation
 * Part of the Advanced 3D Rendering Engine
 */

#ifndef PHYSICS_SOFT_RENDERER_03_H
#define PHYSICS_SOFT_RENDERER_03_H
...
typedef struct physics_soft_renderer_03 physics_soft_renderer_03_t;
typedef struct physics_soft_renderer_03_desc physics_soft_renderer_03_desc_t;
typedef struct physics_soft_renderer_03_stats physics_soft_renderer_03_stats_t;

/* Creation and destruction */
int physics_soft_renderer_03_create(physics_soft_renderer_03_t** out_ctx, const physics_soft_renderer_03_desc_t* desc);
int physics_soft_renderer_03_destroy(physics_soft_renderer_03_t* ctx);
...
#endif /* PHYSICS_SOFT_RENDERER_03_H */
