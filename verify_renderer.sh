...
echo "Verifying Renderer System integration..."
...
# Test main
TEST_MAIN="Source/Runtime/Rendering/Private/renderer_test_main.c"
...
# Compile
echo "Compiling Renderer System..."
$CC $CFLAGS $INCLUDES \
    $RENDERER_SOURCES \
    $MEMORY_SOURCES \
    $LOGGER_SOURCES \
...
if [ $? -ne 0 ]; then
    echo "Renderer System compilation FAILED."
    exit 1
fi

echo "Renderer System compiled successfully."
echo "Running Renderer Verification..."
./renderer_test

if [ $? -eq 0 ]; then
    echo ""
    echo "Renderer Verification Successful!"
    rm -f renderer_test
else
    echo ""
